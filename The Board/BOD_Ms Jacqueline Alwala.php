...
document.querySelectorAll('#navbarCollapse .nav-link:not(.dropdown-toggle)').forEach(function(link) {
   ...
   <!-- ================= BOARD OF DIRECTORS PROFILE - MS. JACQUELINE ALWALA ================= -->
    <style>
                ...
                <div class="col-lg-5">
                    <div class="sticky-top" style="top: 30px;">
                        ...
                        <div class="position-relative mb-5 text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="position-relative rounded-circle overflow-hidden" 
                                    ...
                                    <img src="img/b8.jpg" class="w-100 h-100" alt="Ms. Jacqueline Alwala" style="object-fit: cover;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <h2 class="serif fw-bold mb-1" style="color: #1e2a1e; font-size: 2rem;">Ms. Jacqueline Alwala</h2>
                        ...
                        <div class="mt-4">
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Masters in Linguistics</div>
                            ...
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Bachelor of Education (Arts)</div>
                                    <small class="text-muted"></small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center py-2">
                                ...
                                <div>
                                    <div class="fw-medium">Education & Community Service</div>
                                    <small class="text-muted">Diocesan & Local Church Leadership</small>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3 hover-lift">
                        <p class="serif fs-3 fw-medium mt-2 mb-0" style="color: #1e2a1e; line-height: 1.4;">
                            "Advancing education, serving the church, and empowering communities."
                        </p>
                    </div>
                    -->
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
                        ...
                        <div class="mb-4" style="line-height: 1.8; color: #2d3a2d;">
                            <p class="mb-4">
                                Ms. Jacqueline Alwala is a dedicated educationist and community servant with strong academic credentials. She holds a Masters in Linguistics and a Bachelor of Education (Arts), which have equipped her with deep insights into language, communication, and educational development. Her academic training provides a strong foundation for her work in both educational policy and community engagement.
                            </p>
                            
                            <p class="mb-4">
                                She is an active member of the Kasipul Kabondo strategic planning committee of education, where she contributes her expertise to shaping educational policies and initiatives at the local level. Her involvement in this committee demonstrates her commitment to improving educational outcomes and opportunities for learners in the region.
                            </p>
                            
                            <p class="mb-4">
                                Ms. Alwala also serves on the Southern Nyanza ACK Guest House board, bringing her leadership and governance skills to this important diocesan institution. Her board experience includes strategic planning, oversight, and ensuring that the guest house fulfills its mission of providing quality hospitality services while supporting the work of the diocese.
                            </p>
                            
                            <p>
                                Within the Anglican Church of Kenya, Ms. Alwala holds various leadership roles in the Diocese of Southern Nyanza and at the local church level under ACK Upper Oyugis Archdeaconry. Her active participation in church governance and ministry reflects her deep faith and commitment to serving her community through both educational and spiritual avenues. This combination of educational expertise and church leadership brings a valuable perspective to the ADS Nyanza Board of Directors.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>MA</h3>
                                <p class="small text-muted mb-0">Linguistics</p>
                                <p class="small fw-medium">Masters Degree</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>BEd</h3>
                                <p class="small text-muted mb-0">Arts</p>
                                <p class="small fw-medium">Bachelor of Education</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>ACK</h3>
                                <p class="small text-muted mb-0">Diocesan & Local</p>
                                <p class="small fw-medium">Church Leadership</p>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Current Roles & Committees -->
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
    ...
    <div class="col-md-12">
        <ul class="list-unstyled">
            <li class="mb-4 d-flex">
                ...
                <div>
                    <div class="fw-bold fs-6" style="color: #1e2a1e;">Member</div>
                    <small class="text-muted">Kasipul Kabondo Strategic Planning Committee of Education</small>
                </div>
            </li>
            <li class="mb-4 d-flex">
                <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                <div>
                    ...
                    <small class="text-muted">Southern Nyanza ACK Guest House Board</small>
                </div>
            </li>
            <li class="mb-4 d-flex">
                <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                <div>
                    <div class="fw-bold fs-6" style="color: #1e2a1e;">Church Leadership</div>
                    <small class="text-muted">Diocese of Southern Nyanza</small>
                </div>
            </li>
            <li class="d-flex">
                <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                <div>
                    <div class="fw-bold fs-6" style="color: #1e2a1e;">Local Church Leader</div>
                    <small class="text-muted">ACK Upper Oyugis Archdeaconry</small>
                </div>
            </li>
        </ul>
    </div>
                    ...
                    <div class="p-5 mb-5 rounded-3 bg-white shadow-sm" style="border-top: 4px solid #2e7d32;">
                        ...
                        <p class="text-muted mb-0" style="line-height: 1.8;">
                            As a member of the Board of Directors at ADS Nyanza, Ms. Jacqueline Alwala brings valuable experience in educational planning, board governance, and church leadership. Her work on the Kasipul Kabondo education committee provides insights into local educational needs and policy implementation. Her service on the ACK Guest House board contributes to her understanding of institutional governance. Additionally, her active roles within the Diocese of Southern Nyanza and Upper Oyugis Archdeaconry ensure that ADS Nyanza's community initiatives remain connected to and supported by local church structures, enhancing the organization's reach and impact across the region.
                        </p>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <div class="text-end">
                            <div class="small text-muted">Ms. Jacqueline Alwala</div>
    ...
    <!-- End Board of Directors Profile - Ms. Jacqueline Alwala -->

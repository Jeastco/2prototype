...
<!-- ================= BOARD OF DIRECTORS PROFILE - DR. EMILY ================= -->
    <style>
        ...
        <div class="container position-relative py-4">
            ...
            <div class="text-center mb-5">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <span class="gold-dot" style="background: #4CAF50;"></span>
                    <div style="width: 40px; height: 1px; background: #2e7d32;"></div>
                </div>
            </div>
                ...
                <div class="col-lg-5">
                    <div class="sticky-top" style="top: 30px;">
                        ...
                        <div class="position-relative mb-5 text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="position-relative rounded-circle overflow-hidden" 
                                    ...
                                    <img src="img/b5.jpg" class="w-100 h-100" alt="Dr. Emily" style="object-fit: cover;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <h2 class="serif fw-bold mb-1" style="color: #1e2a1e; font-size: 2rem;">The Rt. Rev'd Dr. Emily Awino Onyango</h2>
                            <h2 class="serif fw-bold mb-3" style="color: #1e2a1e; font-size: 2.2rem; line-height: 1.1;"></h2>
                            ...
                            <p class="text-success fw-semibold mb-4 d-flex align-items-center justify-content-center">
                        ...
                        <div class="mt-4">
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">PhD in History</div>
                                    <small class="text-muted">University of Wales</small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Master of Theology (Church History)</div>
                                    <small class="text-muted">Asian Centre of Theological Studies, Seoul</small>
                                </div>
                            </div>
                            
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                <span class="text-success me-3" style="width: 30px;"><i class="bi bi-journal-bookmark-fill"></i></span>
                                <div>
                            ...
                            <div class="d-flex align-items-center py-2">
                                ...
                                <div>
                                    <div class="fw-medium">Executive Director</div>
                                    <small class="text-muted">CAWLRA</small>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
                        ...
                        <div class="mb-4" style="line-height: 1.8; color: #2d3a2d;">
                            <p class="mb-4">
                                Dr. Emily holds a PhD in History from the University of Wales, a Master of Theology (Church History) from the Asian Centre of Theological Studies in Seoul, and a Bachelor of Divinity from St. Paul's University. Her extensive academic training has equipped her with deep historical perspectives and theological insights that inform her work in church leadership, education, and gender advocacy.
                            </p>
                            
                            <p class="mb-4">
                                An Assistant Bishop of ACK Bondo Diocese, she also serves as the Executive Director of CAWLRA (Centre for Anglican Women Leadership Training and Research in Africa) — a centre founded by African women Bishops to empower and equip women for leadership roles in the church and society. In addition, she is a Senior Lecturer at St. Paul's University, shaping the next generation of theological students and church leaders.
                            </p>
                            
                            <p class="mb-4">
                                Dr. Emily is an active member of several committees and professional bodies, including:
                            </p>
                            
                            <ul class="list-unstyled mb-4">
                                <li class="mb-2 d-flex">
                                    <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                    <span>Anglican Communion Science Commission</span>
                                </li>
                                <li class="mb-2 d-flex">
                                    <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                    <span>Africa Faith Actors Network on Justice and Climate Change (All Africa Conference of Churches)</span>
                                </li>
                                <li class="mb-2 d-flex">
                                    <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                    <span>Concerned African Women Theologians</span>
                                </li>
                                <li class="mb-2 d-flex">
                                    <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                    <span>Provincial Board of Education and Training</span>
                                </li>
                                <li class="mb-2 d-flex">
                                    <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                    <span>Provincial (ACK) Liturgical Committee</span>
                                </li>
                                <li class="mb-2 d-flex">
                                    <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                    <span>Christians for Biblical Equality International</span>
                                </li>
                            </ul>
                            
                            <p class="mb-4">
                                She serves as Chair of the Board of Management for Nyamira Girls High School and also chairs the African Centre for Biblical Equity at St. Paul's University (SPU). Her leadership in education extends beyond the classroom into governance and policy development.
                            </p>
                            
                            <p>
                                Dr. Emily is an accomplished author who has written numerous journal articles and books on gender and development, women leaders, and the impact of education in integral development. Her scholarly work continues to influence discourse on women's leadership and empowerment across Africa and beyond.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>PhD</h3>
                                <p class="small text-muted mb-0">History</p>
                                <p class="small fw-medium">University of Wales</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>Author</h3>
                                <p class="small text-muted mb-0">Journal Articles</p>
                                <p class="small fw-medium">& Books</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>10+</h3>
                                <p class="small text-muted mb-0">Professional</p>
                                <p class="small fw-medium">Committees & Bodies</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Assistant Bishop, ACK Bondo Diocese</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Executive Director, CAWLRA</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Senior Lecturer, St. Paul's University</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Chair, Nyamira Girls High School Board</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Chair, African Centre for Biblical Equity (SPU)</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <!-- ADS Nyanza role -->
                    <div class="p-5 mb-5 rounded-3 bg-white shadow-sm" style="border-top: 4px solid rgb(63, 198, 92);">
                        <h4 class="fw-bold mb-3" style="color: #1e2a1e;">Board Member, ADS Nyanza</h4>
                        <p class="text-muted mb-0" style="line-height: 1.8;">
                            As a member of the Board of Directors at ADS Nyanza, Dr. Emily brings extensive experience in theological education, women's leadership development, and community empowerment. Her expertise in gender and development, combined with her deep commitment to holistic community transformation, strengthens the board's capacity to advance initiatives that serve vulnerable populations across the Nyanza region.
                        </p>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <div class="text-end">
                            <div class="small text-muted">The Rt. Rev'd Dr. Emily Awino Onyango</div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-3">
                        ...
                        <span class="small" style="color: #C6A43F;"> </span>
                    </div>
                </div>
            </div>
    ...
    <!-- End Board of Directors Profile - Dr. Emily -->

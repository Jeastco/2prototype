...
<!-- ================= BOARD OF DIRECTORS PROFILE - MRS. NELLY ATIENO OTIENO ================= -->
    <style>
    ...
    <div class="board-profile container-fluid py-5 position-relative" style="background: #fcfcfc;">
        ...
        <div class="container position-relative py-4">
           ...
           <div class="text-center mb-5">
                ...
                <h1 class="serif display-5 fw-bold mt-3 mb-3" style="color: #1e2a1e;">Programs Chairlady</h1>
                ...
                <div class="col-lg-5">
                    <div class="sticky-top" style="top: 30px;">
                        ...
                        <div class="position-relative mb-5 text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="position-relative rounded-circle overflow-hidden" 
                                    ...
                                    <img src="img/b3.jpg" class="w-100 h-100" alt="Mrs. Nelly Atieno Otieno" style="object-fit: cover;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <h2 class="serif fw-bold mb-1" style="color: #1e2a1e; font-size: 2rem;">Mrs. Nelly Atieno Otieno</h2>
                        ...
                        <div class="mt-4">
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Degree in Management</div>
                                    <small class="text-muted">European School of Business Studies</small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Diploma in Cooperatives Management</div>
                                    <small class="text-muted">Cooperative College, Kenya</small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center py-2">
                                ...
                                <div>
                                    <div class="fw-medium">Consultant in Financial Inclusion</div>
                                    <small class="text-muted">MSME Development Specialist</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accent-panel mt-5">
                            ...
                            <h5 class="fw-bold mb-0" style="color: #1e2a1e;">Programs Chairlady</h5>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3 hover-lift">
                        <p class="serif fs-3 fw-medium mt-2 mb-0" style="color: #1e2a1e; line-height: 1.4;">
                            "Empowering communities through financial inclusion and enterprise development."
                        </p>
                    </div>
                     -->
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
                        ...
                        <div class="mb-4" style="line-height: 1.8; color: #2d3a2d;">
                            <p class="mb-4">
                                Mrs. Nelly Otieno holds a degree in Management from the European School of Business Studies and a Diploma in Cooperatives Management from the Cooperative College in Kenya. Her educational background has provided her with a strong foundation in organizational leadership, business development, and cooperative enterprise management.
                            </p>
                            
                            <p class="mb-4">
                                Currently, she serves as a Consultant in Financial Inclusion, bringing vast experience in the development and management of micro, small, and medium-scale enterprises (MSMEs). Her work focuses on creating pathways for economic empowerment, particularly for women and underserved communities, enabling them to access financial services and build sustainable livelihoods.
                            </p>
                            
                            <p class="mb-4">
                                Mrs. Otieno serves as a board member of CARE International Kenya, one of the leading humanitarian organizations dedicated to fighting poverty and social injustice. Her governance experience at CARE Kenya informs her strategic contributions to ADS Nyanza's board, particularly in program design, monitoring, and evaluation.
                            </p>
                            
                            <p>
                                Formerly a team member of Women Economic Empowerment at CARE Kenya, she has been at the forefront of initiatives that promote gender equality and economic justice. Her hands-on experience in women's economic empowerment programming brings practical insights to ADS Nyanza's community development efforts.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>BSc</h3>
                                <p class="small text-muted mb-0">Management</p>
                                <p class="small fw-medium">European School</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>Diploma</h3>
                                <p class="small text-muted mb-0">Cooperatives</p>
                                <p class="small fw-medium">Cooperative College</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>CARE</h3>
                                <p class="small text-muted mb-0">Board Member</p>
                                <p class="small fw-medium">International Kenya</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(39, 184, 46);"></i>
                                        <span>Financial Inclusion</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(39, 184, 46);"></i>
                                        <span>MSME Development</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(39, 184, 46);"></i>
                                        <span>Women Economic Empowerment</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="p-5 mb-5 rounded-3 bg-white shadow-sm" style="border-top: 4px solid #2e7d32;">
                        <h4 class="fw-bold mb-3" style="color: #1e2a1e;">Programs Chairlady, ADS Nyanza</h4>
                        <p class="text-muted mb-0" style="line-height: 1.8;">
                            As Programs Chairlady of the Board of Directors at ADS Nyanza, Mrs. Otieno provides strategic oversight for all programmatic initiatives. Her extensive experience in financial inclusion, enterprise development, and women's economic empowerment guides the organization's efforts to design and implement impactful community programs. She ensures that ADS Nyanza's interventions are evidence-based, sustainable, and responsive to the needs of vulnerable populations across the Nyanza region.
                        </p>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <div class="text-end">
                            <div class="small text-muted">Mrs. Nelly Atieno Otieno</div>
                            <div class="small text-success">Programs Chairlady, Board of Directors</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- End Board of Directors Profile - Mrs. Nelly Atieno Otieno -->
<!-- Footer Start -->

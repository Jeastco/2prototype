...
document.querySelectorAll('#navbarCollapse .nav-link:not(.dropdown-toggle)').forEach(function(link) {
    ...
    <!-- ================= STAFF PROFILE - THE RT. REV'D CHARLES OCHIENG ONG'INJO ================= -->
            ...
            <div class="row g-5">
                        ...
                        <div class="text-center p-5 rounded-4 shadow-sm border-0 position-relative bg-white" 
                            ...
                            <div class="position-relative mx-auto mb-4" style="width: 240px; height: 240px;">
                                ...
                                <img class="img-fluid rounded-circle shadow-lg border border-5 border-white" 
                                     src="img/t3.jpg" 
                                     alt="The Rt. Rev'd Charles Ochieng Ong'injo" 
                                     style="width: 100%; height: 100%; object-fit: cover; position: relative; z-index: 2;">
                            </div>

                            <h3 class="fw-bold mb-1" style="color: #091E3E; font-family: 'Playfair Display', serif;">The Rt. Rev’d Charles Ochieng Ong’injo</h3>
                            <p class="text-uppercase fw-bold mb-4" style="color: #2e7d32; letter-spacing: 2px; font-size: 0.8rem;">
                                Member, Board of Trustees | Diocesan Bishop, Maseno South
                            </p>
                            
                            <hr class="w-25 mx-auto mb-4" style="color: #2e7d32; height: 2px; opacity: 1;">

                            <div class="d-flex flex-column gap-2 text-start">
                                <div class="d-flex align-items-center small text-muted"><i class="bi bi-check2-circle text-success me-2"></i>Master of Arts in Religion – Maseno University</div>
                                <div class="d-flex align-items-center small text-muted"><i class="bi bi-check2-circle text-success me-2"></i>Bachelor of Divinity – St. Paul’s University</div>
                                <div class="d-flex align-items-center small text-muted"><i class="bi bi-check2-circle text-success me-2"></i>Diocesan Bishop, Maseno South</div>
                                <div class="d-flex align-items-center small text-muted"><i class="bi bi-check2-circle text-success me-2"></i>Former Vicar General, Maseno South</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="ps-lg-5">
                        ...
                        <div class="mb-5">
                            <h6 class="text-uppercase fw-bold mb-2" style="color: #2e7d32; letter-spacing: 4px;">Anglican Leadership & Trusteeship</h6>
                        ...
                        <div class="bio-content" style="color: #4a4a4a; line-height: 1.9; font-size: 1.1rem; text-align: justify;">
                            ...
                            <p class="mb-4">
                                The bishop is a holder of a Master of Arts in Religion from Maseno University and a Bachelor's of Divinity of St. Paul's University. Presently, he is the Diocesan Bishop of the Anglican Diocese of Maseno South and was previously the Vicar General of the same Diocese, besides being an Archdeacon, a Rural Dean, and a Vicar responsible for Pastoral and Parochial duties and a Theological Education by Extension Trainer.
                            </p>

                            <p class="mb-4">
                                He has been the Vice Chairman of Kisumu County Education Board, a member of Kisumu West Technical committee on HIV/AIDS, a member of Probation and after care committee, a member of the Court users' committee at Maseno Law Courts, and a Presiding Officer of the Electoral Commission of Kenya. He has also served in various Boards of Managements of Schools, among them Maseno Girls Boarding, Chulaimbo Secondary School, Wagwer Secondary School, and Maseno School for the Deaf.
                            </p>

                            <p class="mb-4">
                                Bishop Charles spearheaded the establishment of All Saints Academy Primary School, a successful Church venture, modeling students using the Gospel. He has been the Chairman of Global Faith Partnership, an Orphans and Vulnerable Children (OVC) student feeding project that enables Students feed well and concentrate on their studies.
                            </p>
                            ...
                            <div class="card border-0 bg-light p-4 mb-4 shadow-sm" style="border-left: 5px solid #2e7d32 !important;">
                                <p class="m-0 fst-italic">
                                    As a Member of the Board of Trustees at ADS Nyanza, Bishop Charles provides strategic oversight and spiritual guidance, ensuring that the organization's community development initiatives align with faith-based values and serve the most vulnerable populations in the region.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mt-5 pt-5 border-top border-light">
                            <div class="col-sm-4 text-center text-sm-start">
                                <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">MA</h2>
                                <span class="text-uppercase tracking-widest text-muted small fw-bold">Maseno University</span>
                            </div>
                            <div class="col-sm-4 text-center text-sm-start">
                                <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">20+</h2>
                                <span class="text-uppercase tracking-widest text-muted small fw-bold">Years in Ministry</span>
                            </div>
                            <div class="col-sm-4 text-center text-sm-start">
                                <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">5+</h2>
                                <span class="text-uppercase tracking-widest text-muted small fw-bold">School Boards</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--End_Staff Profile - Charles Ochieng Ong'injo-->

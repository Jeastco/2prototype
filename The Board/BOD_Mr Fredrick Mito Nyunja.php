...
<!-- ================= BOARD OF DIRECTORS PROFILE - MR. FREDRICK MITO NYUNJA ================= -->
    <style>
                ...
                <div class="col-lg-5">
                    <div class="sticky-top" style="top: 30px;">
                        ...
                        <div class="position-relative mb-5 text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="position-relative rounded-circle overflow-hidden" 
                                    ...
                                    <img src="img/b7.jpg" class="w-100 h-100" alt="Mr. Fredrick Mito Nyunja" style="object-fit: cover;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <h2 class="serif fw-bold mb-1" style="color: #1e2a1e; font-size: 2rem;">Mr. Fredrick Mito Nyunja</h2>
                        ...
                        <div class="mt-4">
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Masters in Community Health & Development</div>
                            ...
                            <div class="d-flex align-items-center py-2">
                                ...
                                <div>
                                    <div class="fw-medium">16+ Years Experience</div>
                                    <small class="text-muted">Education & Community Health</small>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3 hover-lift">
                        <p class="serif fs-3 fw-medium mt-2 mb-0" style="color: #1e2a1e; line-height: 1.4;">
                            "Bridging education and community health for sustainable development."
                        </p>
                    </div>
                    -->
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
                        ...
                        <div class="mb-4" style="line-height: 1.8; color: #2d3a2d;">
                            <p class="mb-4">
                                Mr. Fredrick Mito Nyunja is a dedicated professional with a strong background in both education and community health. He holds a Masters of Community Health and Development from Great Lakes University and a Bachelor of Education (Arts) from Maseno University. This unique combination of qualifications has equipped him with a holistic understanding of community development challenges and solutions.
                            </p>
                            
                            <p class="mb-4">
                                With 16 years of experience as an educationist, Mr. Nyunja brings deep insights into the educational sector and its intersection with community wellbeing. His extensive experience in teaching and educational administration has provided him with valuable skills in communication, capacity building, and stakeholder engagement.
                            </p>
                            
                            <p class="mb-4">
                                Currently, he serves as the Director of Odede Community Health Centre, where he oversees healthcare delivery and community health programs. In this role, he has been instrumental in improving access to quality healthcare services for underserved populations and strengthening community health systems.
                            </p>
                            
                            <p>
                                Additionally, Mr. Nyunja serves as the In-Country Coordinator for World Youth International – Yala, Siaya County. In this capacity, he coordinates international development initiatives, manages partnerships, and ensures effective implementation of programs that benefit local communities, particularly in the areas of health, education, and youth development.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <p class="small fw-medium">Great Lakes</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <p class="small fw-medium">Education Experience</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>Director</h3>
                                <p class="small text-muted mb-0">Odede Community</p>
                                <p class="small fw-medium">Health Centre</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <ul class="list-unstyled">
                                    <li class="mb-4 d-flex">
                                        ...
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Director</div>
                                            <small class="text-muted">Odede Community Health Centre</small>
                                        </div>
                                    </li>
                                    <li class="mb-4 d-flex">
                                        <div class="me-3">
                                        ...
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">In-Country Coordinator</div>
                                            <small class="text-muted">World Youth International – Yala, Siaya County</small>
                                        </div>
                                    </li>
                                    <li class="d-flex">
                                        <div class="me-3">
                                        ...
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Educationist</div>
                                            <small class="text-muted">16+ Years Experience</small>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="p-5 mb-5 rounded-3 bg-white shadow-sm" style="border-top: 4px solid #2e7d32;">
                        ...
                        <p class="text-muted mb-0" style="line-height: 1.8;">
                            As a member of the Board of Directors at ADS Nyanza, Mr. Fredrick Mito Nyunja brings a wealth of experience in community health, education, and international development coordination. His dual background in education and community health provides valuable insights into the interconnected challenges facing vulnerable communities. His experience managing health programs at Odede Community Health Centre and coordinating international partnerships with World Youth International strengthens the board's capacity to design and implement holistic, sustainable development initiatives across the Nyanza region.
                        </p>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <div class="text-end">
                            <div class="small text-muted">Mr. Fredrick Mito Nyunja</div>
    ...
    <!-- End Board of Directors Profile - Mr. Fredrick Mito Nyunja -->
<!-- Footer Start -->

...
<!-- ================= BOARD OF DIRECTORS PROFILE - THE RT. REV'D CPA. BENARD ENOS OTIENO OWUOR ================= -->
    <style>
    ...
    <div class="treasurer-profile container-fluid py-5 position-relative" style="background: #fcfcfc;">
        <!-- Subtle background texture - different pattern from Chairman -->
       
        
        <div class="container position-relative py-4">
            
            <!-- Distinct header for Treasurer - different from Chairman -->
            <div class="text-center mb-5">
                ...
                <h1 class="serif display-5 fw-bold mt-3 mb-3" style="color: #1e2a1e;">Honorary Treasurer, Finance & Admin</h1>
            ...
            <!-- Main profile card - similar structure but distinct styling -->
            <div class="row g-5 justify-content-center">
                <!-- Left column - Portrait and credentials -->
                <div class="col-lg-5">
                    <div class="sticky-top" style="top: 30px;">
    <!-- Portrait - circular like the others -->
    <div class="position-relative mb-5 text-center">
        <div class="position-relative d-inline-block">
            <!-- Subtle outer ring (similar to other profiles) -->
            ...
            <div class="position-relative rounded-circle overflow-hidden" 
                ...
                <img src="img/enos.jpg" class="w-100 h-100" alt="Bishop Benard" style="object-fit: cover;">
            </div>
        </div>
    </div>
...
<div class="text-center">
    <h2 class="serif fw-bold mb-1" style="color: #1e2a1e; font-size: 2rem;">The Rt. Rev'd CPA.</h2>
    <h2 class="serif fw-bold mb-3" style="color: #1e2a1e; font-size: 2.2rem; line-height: 1.1;">Benard Enos Otieno Owuor</h2>
    ...
    <p class="text-success fw-semibold mb-4 d-flex align-items-center justify-content-center">
        <i class="bi bi-piggy-bank me-2" style="color: #C6A43F;"></i>
        Diocesan Bishop, Maseno East
    </p>
</div>
                        
                        <!-- Credentials with financial emphasis -->
                        <div class="mt-4">
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Masters in Theology</div>
                                    <small class="text-muted">Great Lakes University</small>
                                </div>
                            </div>
                            
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                <span class="text-success me-3" style="width: 30px;"><i class="bi bi-briefcase"></i></span>
                                <div>
                                    <div class="fw-medium">MBA (Finance)</div>
                                    <small class="text-muted">University of Nairobi</small>
                                </div>
                            </div>
                            
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                <span class="text-success me-3" style="width: 30px;"><i class="bi bi-calculator"></i></span>
                                <div>
                                    <div class="fw-medium">BBA (Accounting)</div>
                                    <small class="text-muted">Maseno University</small>
                                </div>
                            </div>
                            
                            <div class="d-flex align-items-center py-2">
                                <span class="text-success me-3" style="width: 30px;"><i class="bi bi-award"></i></span>
                                <div>
                                    <div class="fw-medium">CPA(K) Finalist</div>
                                    <small class="text-muted">12+ Years Financial Management</small>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-7">
                    <!-- Welcome card with financial theme
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3 hover-lift">
                        <div class="d-flex align-items-center mb-3">
                            <i class="bi bi-calculator-fill text-success me-2"></i>
                            <span class="text-success fw-semibold small text-uppercase tracking-wide">Office of the Honorary Treasurer</span>
                        </div>
                        <p class="serif fs-3 fw-medium mt-2 mb-0" style="color: #1e2a1e; line-height: 1.4;">
                            "Stewardship of resources, integrity in management, and service to the vulnerable."
                        </p>
                    </div>
                     -->
                    <!-- Biography section -->
                    ...
                    <!-- Financial Expertise Cards - distinct from Chairman's layout -->
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                <i class="bi bi-bank fs-1 text-success mb-2"></i>
                                <h3>MBA</h3>
                                <p class="small text-muted mb-0">Finance</p>
                                <p class="small fw-medium">University of Nairobi</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <p class="small fw-medium">Financial Management</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>CPA</h3>
                                <p class="small text-muted mb-0">Finalist</p>
                                <p class="small fw-medium">Certified Public Accountant</p>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Church Leadership Roles - different presentation -->
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
                        <h3 class="serif fw-bold mb-4 d-flex align-items-center" style="color: #1e2a1e;">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                       <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Bishop's Chaplaincy Duties</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                       <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                    ...
                                    <li class="mb-3 d-flex">
                                       <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Regional Coordinator - KAMA</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Diocesan Coordinator - KAMA</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                       <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Trainer of Church Leaders</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(36, 206, 36);"></i>
                                        <span>Finance & Audit Committee</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <!-- ADS Nyanza role - distinct from Chairman's version -->
                    <div class="p-5 mb-5 rounded-3 bg-white shadow-sm" style="border-top: 4px solid rgb(63, 198, 92);">
    <h4 class="fw-bold mb-3" style="color: #1e2a1e;">Honorary Treasurer, Finance & Admin</h4>
    <p class="text-muted mb-0" style="line-height: 1.8;">
        As a Member of the Board of Directors at ADS Nyanza serving in this key financial oversight role, Bishop Benard brings invaluable financial acumen and spiritual leadership to the organization. His expertise in accounting, auditing, and management, combined with his deep commitment to servant leadership, strengthens the board's capacity for strategic governance, ensuring that resources are managed responsibly to maximize impact for vulnerable communities in the Nyanza region.
    </p>
</div>
                    
                    <!-- Signature footer - similar but distinct -->
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <div class="text-end">
                            <div class="small text-muted">The Rt. Rev'd CPA. Benard Enos Otieno Owuor</div>
                            <div class="small text-success">Honorary Treasurer, Finance & Admin</div>
                        </div>
                    </div>
                </div>
            </div>
            
            <!-- Footer bar - similar but distinct -->
            <div class="row mt-5">
                <div class="col-12">
                    <hr class="opacity-25">
    ...
    <!-- End Board of Directors Profile - Honorary Treasurer -->

...
document.querySelectorAll('#navbarCollapse .nav-link:not(.dropdown-toggle)').forEach(function(link) {
    ...
    <!-- ================= STAFF PROFILE (UPDATED WITH EXACT BIOGRAPHY) ================= -->
...
<div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
    <div class="sticky-top" style="top:100px; z-index:1;">
        ...
        <div class="text-center p-5 bg-white rounded-4 shadow-sm"
             style="border:1px solid #edf2ef;">

            <!-- Profile Image -->
            <div class="position-relative mx-auto mb-4 profile-image">
                ...
                <!-- Main Image -->
                <img src="img/t2.JPG"
                     alt="The Rt. Rev’d Prof. David Hellington Kodia"
                     class="img-fluid rounded-circle shadow">

            </div>

            <h3 class="fw-bold mb-2"
                style="color:#091E3E; font-family:'Playfair Display', serif;">
                The Rt. Rev’d Prof. David Hellington Kodia
            </h3>

            <p class="text-uppercase fw-bold mb-4"
               style="color:#2e7d32; letter-spacing:2px; font-size:.8rem;">
                Diocesan Bishop, Anglican Diocese of Bondo
            </p>

            <hr class="w-25 mx-auto mb-4"
                style="height:2px; background:#2e7d32; opacity:1;">
            ...
            <div class="d-flex flex-column gap-3 text-start">
                ...
                <div class="d-flex align-items-start">
                    ...
                    <small class="text-muted">
                        PhD (Summa cum laude) – Northwestern Christian University
                    </small>
                </div>
                ...
                <div class="d-flex align-items-start">
                    <i class="bi bi-check2-circle text-success me-2 mt-1"></i>
                    <small class="text-muted">
                        Master's in Theology, Charles University, Prague
                    </small>
                </div>
                ...
                <div class="d-flex align-items-start">
                    <i class="bi bi-check2-circle text-success me-2 mt-1"></i>
                    <small class="text-muted">
                        Bachelor's in Theology, Charles University, Prague
                    </small>
                </div>
                ...
                <div class="d-flex align-items-start">
                    <i class="bi bi-check2-circle text-success me-2 mt-1"></i>
                    <small class="text-muted">
                        Canon Theologian • Author • Scholar
                    </small>
                </div>
                ...
                <!-- right column : full biography (exact wording as requested) -->
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="ps-lg-5">
                        
                        <div class="mb-5">
                            <h6 class="text-uppercase fw-bold mb-2" style="color: #2e7d32; letter-spacing: 4px;">Episcopal Leadership & Scholarship</h6>
                        ...
                        <div class="bio-content" style="color: #4a4a4a; line-height: 1.9; font-size: 1.1rem; text-align: justify;">
                            <!-- EXACT WORDING PROVIDED, VERBATIM -->
                            <p class="mb-4">
                                Prof. Kodia is a holder of a PhD (Summa cum laude) of Northwestern Christian University, a master’s in theology, and a bachelor’s in theology of Charles University in Prague. He has written and published in the following areas The Sociology, Theology, and Intricacies of Truth in Modern Society, Towards a ministry of social service and challenges of volunteerism in the church and society in Africa, Religious, Cultural and social burdens as major contributing factors in the level of poverty in Africa, The Role of the church in democratization processes in Kenya, The Prognosis of the Church’s involvement in Development in the context of her mission, Gendered Economic and Social privileges as an obstruction to Biblical Justice, Balancing a Gendered Worldview: Politics and Religion in Focus, Volunteerism and Development, Poverty in Grace: Social Responsibility of the Church and Society in war against Poverty Nairobi, Theology and Politics of Biblical Exposition and its relevance to Church and society, Mission to the Voiceless and Sharing of Mission.
                            </p>

                            <p class="mb-4">
                                He is presently the Diocesan Bishop of the Anglican Diocese of Bondo and has previously been Ag. Vice Chancellor for Great Lakes University of Kisumu (GLUK), Principal of Bishop Okullu College, Registrar of GLUK, Director of Studies at Carlile College, and Principal of St. Philips Bible College. The bishop has carried out several consultancies in Ghana and Southern Sudan, including Strategic Plan development and peace and Conflict resolutions.
                            </p>

                            <p class="mb-4">
                                The bishop has held various governance positions, among them the Clerical Secretary to the Provincial Synod of the Anglican Church of Kenya, a member of the committee on communication and research, the secretary of the Health and HIV/AIDS committee, and the Anglican Colleges at the provincial synod level, and a member of the permanent commission on subdivision of Anglican Dioceses. He has also been collated and installed as a Canon Theologian.
                            </p>

                            <!-- Additional note on current role at ADS Nyanza (contextual, not part of the verbatim but adds relevance) -->
                            <div class="card border-0 bg-light p-4 mb-4 shadow-sm" style="border-left: 5px solid #2e7d32 !important;">
                                <p class="m-0 fst-italic">
                                    In partnership with ADS Nyanza, the Bishop provides strategic guidance on community development, faith-based initiatives, and theological reflection, drawing from his extensive experience in academia, church governance, and peace-building.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mt-5 pt-5 border-top border-light">
                            <div class="col-sm-4 text-center text-sm-start">
                                <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">PhD</h2>
                                <span class="text-uppercase tracking-widest text-muted small fw-bold">Summa cum laude</span>
                            </div>
                            <div class="col-sm-4 text-center text-sm-start">
                                <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">15+</h2>
                                <span class="text-uppercase tracking-widest text-muted small fw-bold">Publications</span>
                            </div>
                            <div class="col-sm-4 text-center text-sm-start">
                                <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">4</h2>
                                <span class="text-uppercase tracking-widest text-muted small fw-bold">Academic Principalships</span>
                            </div>
                        </div>
                    </div>
                </div>

...
<!-- ================= BOARD OF DIRECTORS PROFILE - MR. SAMWEL OMONDI OCHIENG ================= -->
    <style>
    ...
    <div class="board-profile container-fluid py-5 position-relative" style="background: #fcfcfc;">
        ...
        <div class="container position-relative py-4">
            ...
            <div class="text-center mb-5">
                ...
                <h1 class="serif display-5 fw-bold mt-3 mb-3" style="color: #1e2a1e;">Executive Director</h1>
                ...
                <div class="col-lg-5">
                    <div class="sticky-top" style="top: 30px;">
                        ...
                        <div class="position-relative mb-5 text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <div class="position-relative rounded-circle overflow-hidden" 
                                    ...
                                    <img src="img/b9.jpg" class="w-100 h-100" alt="Mr. Samwel Omondi Ochieng" style="object-fit: cover;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <h2 class="serif fw-bold mb-1" style="color: #1e2a1e; font-size: 2rem;">Mr. Samwel Omondi Ochieng</h2>
                        ...
                        <div class="mt-4">
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Community Health & Development - Great Lakes University</small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Bachelor of Arts</div>
                                    <small class="text-muted">Sociology - University of Nairobi</small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-3 py-2 border-bottom border-light">
                                ...
                                <div>
                                    <div class="fw-medium">Higher Diploma</div>
                                    <small class="text-muted">Community Health & Development - Tropical Institute</small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center py-2">
                                ...
                                <div>
                                    <div class="fw-medium">Certified</div>
                                    <small class="text-muted">Gender Trainings & Counselling</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accent-panel mt-5">
                            ...
                            <h5 class="fw-bold mb-0" style="color: #1e2a1e;">20+ Years</h5>
                            <p class="text-success fw-medium">Strategy, Management & Research</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3 hover-lift">
                        <p class="serif fs-3 fw-medium mt-2 mb-0" style="color: #1e2a1e; line-height: 1.4;">
                            "Leading with vision, serving with integrity, transforming communities."
                        </p>
                    </div>
                    -->
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
                        ...
                        <div class="mb-4" style="line-height: 1.8; color: #2d3a2d;">
                            <p class="mb-4">
                                Mr. Samwel Omondi Ochieng is a seasoned development professional with over 20 years of experience in strategy development, management of consortiums of organizations, resource mobilization, monitoring, evaluation, and research. He holds a Master of Science in Community Health and Development from the Great Lakes University of Kisumu, a Bachelor of Arts in Sociology from the University of Nairobi, and a Higher Diploma in Community Health and Development from the Tropical Institute of Community Health and Development. He is also certified in Gender Trainings and Counselling.
                            </p>
                            
                            <p class="mb-4">
                                Throughout his distinguished career, Mr. Ochieng has held various Board Directorships, demonstrating his leadership and governance expertise. These include service on the Board of Social Services of the Anglican Church of Kenya Countrywide, the Kenya Community Based Health Financing outfit, the Great Lakes University of Kisumu, the Bishop Okullu Campus Board, and Chairman of various School Boards of Management. His board experience spans strategic oversight, policy development, and institutional governance.
                            </p>
                            
                            <p class="mb-4">
                                Previously, he served as a Hospital Administrator, where he gained valuable experience in health systems management. He also worked as a Gender Coordinator covering the entire country, leading initiatives to promote gender equality and integrate gender perspectives into development programs. As a Program Manager, he was responsible for designing community interventions, providing oversight, and offering strategic advice for successful program implementation.
                            </p>
                            
                            <p>
                                In addition to his administrative and leadership roles, Mr. Ochieng is a Part-time Lecturer and researcher. He has made publications on food security, contributing to the body of knowledge on this critical development issue. His combination of practical experience, academic engagement, and research expertise brings a comprehensive perspective to his role as Executive Director of ADS Nyanza.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>MSc</h3>
                                <p class="small text-muted mb-0">Community Health</p>
                                <p class="small fw-medium">Great Lakes University</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>20+</h3>
                                <p class="small text-muted mb-0">Years</p>
                                <p class="small fw-medium">Leadership Experience</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="stat-card h-100">
                                ...
                                <h3>Board</h3>
                                <p class="small text-muted mb-0">Multiple</p>
                                <p class="small fw-medium">Directorships</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(58, 177, 64);"></i>
                                        <span>Strategy Development</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(58, 177, 64);"></i>
                                        <span>Consortium Management</span>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-2 fs-6" style="color: rgb(58, 177, 64);"></i>
                    ...
                    <div class="bg-white p-5 mb-5 soft-shadow rounded-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Board Member</div>
                                            <small class="text-muted">Board of Social Services - Anglican Church of Kenya Countrywide</small>
                                        </div>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Board Member</div>
                                            <small class="text-muted">Kenya Community Based Health Financing Outfit</small>
                                        </div>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Board Member</div>
                                            <small class="text-muted">Great Lakes University of Kisumu</small>
                                        </div>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Board Member</div>
                                            <small class="text-muted">Bishop Okullu Campus Board</small>
                                        </div>
                                    </li>
                                    <li class="d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Chairman</div>
                                            <small class="text-muted">Various School Boards of Management</small>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-12">
                                <ul class="list-unstyled">
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Hospital Administrator</div>
                                        </div>
                                    </li>
                                    <li class="mb-3 d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Gender Coordinator</div>
                                            <small class="text-muted">Country-wide Coverage</small>
                                        </div>
                                    </li>
                                    <li class="d-flex">
                                        <i class="bi bi-check-circle-fill me-3 fs-5" style="color: rgb(58, 177, 64);"></i>
                                        <div>
                                            <div class="fw-bold fs-6" style="color: #1e2a1e;">Program Manager</div>
                                            <small class="text-muted">Community Interventions Design & Oversight</small>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="p-5 mb-5 rounded-3 bg-white shadow-sm" style="border-top: 4px solid #2e7d32;">
                        <h4 class="fw-bold mb-3" style="color: #1e2a1e;">Executive Director, ADS Nyanza</h4>
                        <p class="text-muted mb-0" style="line-height: 1.8;">
                            As Executive Director of ADS Nyanza, Mr. Samwel Omondi Ochieng provides strategic leadership and vision for the organization. His extensive experience in strategy development, consortium management, and resource mobilization guides ADS Nyanza's efforts to design and implement impactful community programs. His background in gender mainstreaming, monitoring and evaluation, and research ensures that the organization's interventions are evidence-based, gender-responsive, and sustainable. His previous board leadership roles across multiple institutions strengthen his ability to work effectively with the Board of Directors and steer the organization toward achieving its mission of serving vulnerable communities across the Nyanza region.
                        </p>
                    </div>
                    
                    <!-- Publications note 
                    <div class="p-4 mb-4 rounded-3" style="background-color: #f4f9f4;">
                        <div class="d-flex">
                            <i class="bi bi-journal-text text-success me-3 fs-4"></i>
                            <div>
                                <span class="fw-bold">Publications:</span>
                                <span class="text-muted"> Has made publications on food security, contributing to research and knowledge in community development.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <div class="text-end">
                            <div class="small text-muted">Mr. Samwel Omondi Ochieng</div>
                            <div class="small text-success">Executive Director</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- End Board of Directors Profile - Mr. Samwel Omondi Ochieng -->

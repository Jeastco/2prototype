...
<!-- Past Events Section -->
<section id="past-events" class="container py-5">
    <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 700px;">
        ...
        <h2 class="fw-bold mb-3" style="color: #1a2a3a;">Highlights from Our Journey of Impact</h2>
        <div class="mx-auto rounded-pill mb-3" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
        <p class="text-muted">
            A look back at the activities that continue to shape stronger, more resilient communities across the Nyanza region.
        </p>
    </div>

    <div class="row g-4">
        <!-- Event 1 - World AIDS Day -->
        <div class="col-md-6 col-lg-4">
            <div class="event-card">
                <div class="event-image">
                    <img src="img/nairobi_aids.jpg" alt="World AIDS Day Marathon">
                    <span class="event-date">Dec 1, 2025</span>
                </div>
                <div class="event-content">
                    <h5 class="event-title">World AIDS Day 2025</h5>
                    <p class="event-location"><i class="bi bi-geo-alt-fill"></i> Nairobi, Kenya</p>
                    <p class="event-description">
                        ADS Nyanza staff ran the Half Marathon to demonstrate solidarity and renewed commitment to the fight to end AIDS.
                    </p>
                </div>
            </div>
        </div>

        <!-- Event 2 - PMTCT Milestone -->
        <div class="col-md-6 col-lg-4">
            <div class="event-card">
                <div class="event-image">
                    <img src="img/aids.jpg" alt="PMTCT graduation ceremony">
                    <span class="event-date">Dec 1, 2025</span>
                </div>
                <div class="event-content">
                    <h5 class="event-title">PMTCT Milestone Celebration</h5>
                    <p class="event-location"><i class="bi bi-geo-alt-fill"></i> Homabay County</p>
                    <p class="event-description">
                        Celebrating the successful graduation of over 200 HIV-exposed infants confirmed HIV negative.
                    </p>
                </div>
            </div>
        </div>

        <!-- Event 3 - MTM Research -->
        <div class="col-md-6 col-lg-4">
            <div class="event-card">
                <div class="event-image">
                    <img src="img/mtm4.PNG" alt="MTM Workshop">
                    <span class="event-date">Oct 6, 2025</span>
                </div>
                <div class="event-content">
                    <h5 class="event-title">MTM Research & Learning</h5>
                    <p class="event-location"><i class="bi bi-geo-alt-fill"></i> Nairobi, Kenya</p>
                    <p class="event-description">
                        Improving caregiving and ECD outcomes under the multi-year research study (2023–2025).
                    </p>
                </div>
            </div>
        </div>

        <!-- Event 4 - Tree Growing for Peace -->
        <div class="col-md-6 col-lg-4">
            <div class="event-card">
                <div class="event-image">
                    <img src="img/mazingira1.png" alt="Tree Growing">
                    <span class="event-date">Oct 10, 2025</span>
                </div>
                <div class="event-content">
                    <h5 class="event-title">Tree Growing for Peace</h5>
                    <p class="event-location"><i class="bi bi-geo-alt-fill"></i> Huma Girls, Kisumu</p>
                    <p class="event-description">
                        Community-led reforestation under the PESP Project for long-term environmental stewardship.
                    </p>
                </div>
            </div>
        </div>

        <!-- Event 5 - Mazingira Day -->
        <div class="col-md-6 col-lg-4">
            <div class="event-card">
                <div class="event-image">
                    <img src="img/mazingira2.jpg" alt="Mazingira Day">
                    <span class="event-date">Oct 10, 2025</span>
                </div>
                <div class="event-content">
                    <h5 class="event-title">Mazingira Day Campaign</h5>
                    <p class="event-location"><i class="bi bi-geo-alt-fill"></i> Homa Girls, Kisumu</p>
                    <p class="event-description">
                        Promoting citizen-centric environmental stewardship for a greener Nyanza.
                    </p>
                </div>
            </div>
        </div>

        <!-- Event 6 - Devolution Conference -->
        <div class="col-md-6 col-lg-4">
            <div class="event-card">
                <div class="event-image">
                    <img src="img/devolution.jpg" alt="Devolution Conference">
                    <span class="event-date">Aug 13, 2025</span>
                </div>
                <div class="event-content">
                    <h5 class="event-title">Devolution Conference 2025</h5>
                    <p class="event-location"><i class="bi bi-geo-alt-fill"></i> Homabay County</p>
                    <p class="event-description">
                        Advocating for sustainable development and integrated community health systems at the national level.
                    </p>
                </div>
            </div>
        </div>
...
.event-card:hover {
    ...
    box-shadow: 0 20px 35px rgba(46, 125, 50, 0.1);

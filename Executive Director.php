...
<head>
    ...
    <base href="/updated/">
    <meta charset="utf-8">
    <title>ADS NYANZA - The Executive Director</title>
...
<!-- ================= SENIOR MANAGEMENT - MR. SAMWEL OMONDI OCHIENG ================= -->
<style>
    ...
    <div class="container py-4">
        ...
        <div class="row mb-5">
            <div class="col-md-8">
                ...
                <h1 class="serif display-4 fw-bold mt-3 mb-2" style="color: #1e2a1e;">Samwel Omondi Ochieng</h1>
                <div class="quote-line"></div>
                <p class="text-muted fs-5">Executive Director</p>
            </div>
            <div class="col-md-4 text-md-end">
                <div class="mt-4 mt-md-0">
                    <span class="badge bg-light text-dark px-3 py-2 rounded-pill">20+ Years Experience</span>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="feature-card p-4 rounded-4">
                    <img src="img/sam.jpg" class="img-fluid rounded-3 w-100 mb-4" alt="Mr. Samwel Omondi" style="min-height: 400px; object-fit: cover;">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h6 class="fw-bold mb-0">MSc Community Health</h6>
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h6 class="fw-bold mb-0">BA Sociology</h6>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h6 class="fw-bold mb-0">Higher Diploma</h6>
                            <small class="text-muted">Tropical Institute</small>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <span class="text-muted"> Gender Trainings & Counselling</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-4">
                        <div class="bg-light p-3 rounded-3 text-center">
                            <h3 class="fw-bold text-success mb-0">20+</h3>
                    ...
                    <div class="col-4">
                        <div class="bg-light p-3 rounded-3 text-center">
                            ...
                            <small class="text-muted">Board Roles</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="bg-light p-3 rounded-3 text-center">
                            <h3 class="fw-bold text-success mb-0">MSc</h3>
                            <small class="text-muted">Community Health</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card p-5 rounded-4 mb-4">
                    ...
                    <div class="text-muted" style="line-height: 1.8;">
                        <p class="mb-4">He is a holder of a Master of Science in Community Health and Development of the Great Lakes University of Kisumu, a Bachelor of Arts in Sociology of the University of Nairobi, and a Higher Diploma in Community Health and Development of the Tropical Institute of Community Health and Development, and is certified in Gender trainings and Counselling.</p>
                        
                        <p class="mb-4">He has vast experience of over 20 years in Strategy Development, Management of Consortiums of organizations, resource mobilization, Monitoring, evaluation, and research.</p>
                        
                        <p class="mb-4">Has held various Board Directorships, amongst them the Board of Social Services of the Anglican Church of Kenya Countrywide, Kenya Community Based Health Financing outfit, Great Lakes University of Kisumu, Bishop Okullu Campus Board, and Chairman of Various School Boards of Management.</p>
                        
                        <p>Previously worked as a Hospital Administrator, Gender Coordinator covering the entire country, and a Program Manager charged with, among other Designing community interventions, providing oversight and advice for successful implementation of programs. He is a Part time Lecturer and researcher and has made publications on food security.</p>
                    </div>
                </div>
                
                <!-- Board Roles -->
                <div class="feature-card p-5 rounded-4">
                    <h4 class="serif fw-bold mb-4">Board Directorships</h4>
                    
                    <div class="row">
                        <div class="col-md-6">
                            <div class="board-item">
                                <p class="fw-bold mb-1">ACK Social Services</p>
                                <small class="text-muted">Board Member</small>
                            </div>
                            <div class="board-item">
                                <p class="fw-bold mb-1">Kenya Community Health Financing</p>
                                <small class="text-muted">Board Member</small>
                            </div>
                            <div class="board-item">
                                <p class="fw-bold mb-1">Great Lakes University</p>
                                <small class="text-muted">Board Member</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="board-item">
                                <p class="fw-bold mb-1">Bishop Okullu Campus</p>
                                <small class="text-muted">Board Member</small>
                            </div>
                            <div class="board-item">
                                <p class="fw-bold mb-1">School Boards</p>
                                <small class="text-muted">Chairman (Various)</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <h4 class="serif fw-bold mb-3">Previous Experience</h4>
                    <div class="d-flex flex-wrap gap-2">
                        <span class="expertise-tag">Hospital Administrator</span>
                        <span class="expertise-tag">Gender Coordinator</span>
                        <span class="expertise-tag">Program Manager</span>
                        <span class="expertise-tag">Part-time Lecturer</span>
                        <span class="expertise-tag">Researcher</span>
                    </div>
                </div>
                
                <!-- ADS Nyanza Role -->
                <div class="p-4 mt-4 rounded-3" style="background: #f8fbf8;">
                    <div class="d-flex">
                        <div class="me-3">
                            <i class="bi bi-building text-success fs-3"></i>
                        </div>
                        <div>
                            <h5 class="fw-bold mb-2">Executive Director</h5>
                            <p class="text-muted small mb-0">Provides strategic leadership and governance oversight at ADS Nyanza, ensuring community development initiatives create lasting impact for vulnerable populations across the Nyanza region.</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Publications Note -->
                <div class="mt-4">
                    <p class="small text-muted"><i class="bi bi-journal-text me-2"></i>Published research on food security</p>
                </div>

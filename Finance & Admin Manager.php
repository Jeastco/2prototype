...
<head>
    ...
    <base href="/updated/">
    <meta charset="utf-8">
    <title>ADS NYANZA - Finance & Admin Manager</title>
...
<!-- ================= SENIOR MANAGEMENT - CPA NICHOLAS NYESI ================= -->
<style>
    ...
    <div class="container py-4">
        ...
        <div class="row mb-5">
            <div class="col-md-8">
                ...
                <h1 class="serif display-4 fw-bold mt-3 mb-2" style="color: #1e2a1e;">CPA Nicholas Nyesi</h1>
                <div class="quote-line"></div>
                <p class="text-muted fs-5">Finance & Administration Manager</p>
            </div>
            <div class="col-md-4 text-md-end">
                <div class="mt-4 mt-md-0">
                    <span class="badge bg-light text-dark px-3 py-2 rounded-pill">21+ Years Experience</span>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="feature-card p-4 rounded-4">
                    <img src="img/Nyesi.JPG" class="img-fluid rounded-3 w-100 mb-4" alt="CPA Nicholas Nyesi" style="min-height: 400px; object-fit: cover;">
                    
                    <!-- Professional Affiliations -->
                    <div class="mb-4">
                        <h6 class="fw-bold mb-3">Professional Memberships</h6>
                        <div class="d-flex flex-wrap gap-2">
                            <span class="cert-badge">
                                <i class="bi bi-patch-check-fill text-success"></i> CPA-K
                            </span>
                            <span class="cert-badge">
                                <i class="bi bi-patch-check-fill text-success"></i> ICPAK
                            </span>
                            <span class="cert-badge">
                                <i class="bi bi-patch-check-fill text-success"></i> IHRM
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h6 class="fw-bold mb-0">Master of Science in Entrepreneurship</h6>
                            <small class="text-muted">Jomo Kenyatta University of Agriculture and Technology (JKUAT)</small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h6 class="fw-bold mb-0">Bachelor of Commerce in Finance</h6>
                            <small class="text-muted">The Catholic University of Eastern Africa (CUEA) - Second Class Honors Upper Division</small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <div>
                            <h6 class="fw-bold mb-0">Diploma in Management</h6>
                            <small class="text-muted">Human Resource Option - Kenya Institute of Management (KIM)</small>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <span class="fw-medium text-success">Full member in good standing</span>
                        <span class="text-muted"> of the Institute of Certified Public Accountants of Kenya (ICPAK)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-4">
                        <div class="bg-light p-3 rounded-3 text-center">
                            <h3 class="fw-bold text-success mb-0">21+</h3>
                            <small class="text-muted">Years Financial Management</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="bg-light p-3 rounded-3 text-center">
                            <h3 class="fw-bold text-success mb-0">9+</h3>
                            <small class="text-muted">Years HR Management</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="bg-light p-3 rounded-3 text-center">
                            <h3 class="fw-bold text-success mb-0">6+</h3>
                            <small class="text-muted">Board & Council Roles</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card p-5 rounded-4 mb-4">
                    ...
                    <div class="text-muted" style="line-height: 1.8;">
                        <p class="mb-4">Nicholas Nyesi is a Certified Public Accountant of Kenya (CPA-K) and a distinguished full member in good standing of the Institute of Certified Public Accountants of Kenya (ICPAK), a regulatory body established under the Accountants' Act No. 15 of 2008. ICPAK serves as the cornerstone of the accountancy profession in Kenya, steadfastly ensuring the upholding of excellence and professionalism within the field.</p>
                        
                        <p class="mb-4">In addition, he is a member of the Institute of Human Resource Management Kenya (IHRM), a statutory body established under the Human Resource Management Professionals (HRMP) Act, No. 52 of 2012, which plays a pivotal role in regulating the Human Resource profession in Kenya.</p>
                        
                        <p class="mb-4">Nicholas holds a Master of Science in Entrepreneurship from Jomo Kenyatta University of Agriculture and Technology (JKUAT), a Bachelor of Commerce in Finance from The Catholic University of Eastern Africa (CUEA), where he graduated with Second Class Honors Upper Division, as well as a Diploma in Management with a Human Resource Option from the Kenya Institute of Management (KIM). Nicholas is steadfastly committed to his continuous personal and professional development.</p>
                    </div>
                </div>
                
                <!-- ADS Nyanza Role - Exact Wording -->
                <div class="feature-card p-5 rounded-4 mb-4">
                    <div class="card border-0 p-4" style="border-left: 5px solid #2e7d32 !important; background: #f8fbf8;">
                        <p class="m-0" style="line-height: 1.8;">
                            In his capacity as Finance and Administration Manager at ADS-Nyanza, Nicholas oversees Financial Management, Human Resources coordination, Risk Management, Procurement Management, and logistics coordination. His multifaceted expertise positions him as an invaluable asset in steering the organization towards financial stability and strategic growth.
                        </p>
                    </div>
                </div>
                
                <!-- Board Governance - Exact Wording -->
                <div class="feature-card p-5 rounded-4 mb-4">
                    <p class="mb-4">Beyond the scope of his professional responsibilities, Nicholas has exhibited a profound commitment to governance. His service on various boards—including the Health Innovations of Kenya, the Board of Finance in the Anglican Diocese of Maseno South, Nyabeda Secondary School, the Standing Committee of the Diocesan Synod, and his role as an Executive Council member of the Cathedral—demonstrates his dedication to community development. Furthermore, his involvement with the National Council of the Faith Leaders Early Childhood Development network underscores his fervent passion for effecting positive change.</p>
                    
                    <p>Boasting 21 years of practical, hands-on experience in Financial Management, strategy formulation, and change management, alongside 9 years of specialized proficiency in Human Resource Management, he possesses an ardent passion for reshaping organizations and positively impacting lives.</p>
                </div>
                ...
                <div class="feature-card p-4 rounded-4">
                    ...
                    <div>
                        ...
                        <span class="expertise-tag">Strategy Formulation</span>
                        <span class="expertise-tag">Change Management</span>
                        <span class="expertise-tag">Human Resource Management</span>
                        <span class="expertise-tag">Risk Management</span>
                        <span class="expertise-tag">Procurement Management</span>
                        <span class="expertise-tag">Board Governance</span>
                        <span class="expertise-tag">Logistics Coordination</span>
                    </div>
                </div>
                
                <!-- Stats Row at Bottom (Exact) -->
                <div class="row g-4 mt-5 pt-4 border-top border-light">
                    <div class="col-sm-4 text-center text-sm-start">
                        <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">21+</h2>
                        <span class="text-uppercase tracking-widest text-muted small fw-bold">Finance Expertise</span>
                    </div>
                    <div class="col-sm-4 text-center text-sm-start">
                        <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">9+</h2>
                        <span class="text-uppercase tracking-widest text-muted small fw-bold">HR Leadership</span>
                    </div>
                    <div class="col-sm-4 text-center text-sm-start">
                        <h2 class="display-6 fw-bold mb-0" style="color: #2e7d32;">6+</h2>
                        <span class="text-uppercase tracking-widest text-muted small fw-bold">Board & Council Roles</span>
                    </div>
                </div>
                
                <!-- Signature -->
                <div class="text-end mt-4">
                    <div class="small text-muted">— CPA Nicholas Nyesi</div>
                    <div class="small">Finance & Administration Manager</div>
                </div>
            </div>
        </div>

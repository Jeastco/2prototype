...
<head>
    ...
    <base href="/updated/">
    <meta charset="utf-8">
    <title>ADS Nyanza - Careers</title>
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-4">
                    ...
                    <h1 class="mb-3" style="color: #1a2a3a;">Join Us in Transforming Lives & Communities</h1>
                ...
                <p class="mb-4" style="line-height: 1.8; color: #555;">
                    At ADS–Nyanza, we believe that people are at the heart of sustainable transformation.  
                    We offer opportunities for passionate professionals who wish to make a real difference  
                    in the lives of communities across the region. Explore current openings and join our mission  
                    of empowering lives through impactful partnerships.
                </p>
                <div class="d-flex flex-wrap gap-3">
                    <a href="#open-positions" class="btn-career-primary">
                        <i class="bi bi-briefcase-fill me-2"></i> View Open Positions
                    </a>
                    <a href="#guidelines" class="btn-career-outline">
                        <i class="bi bi-journal-bookmark-fill me-2"></i> Recruitment Guidelines
                    </a>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="career-stats-cards">
                    ...
                    <div class="stat-card closed">
                        ...
                        <div class="stat-info">
                            ...
                            <span class="stat-label">Past Positions</span>
                        </div>
                    </div>
...
<div id="open-positions" class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.2s" style="background: #ffffff;">
    <div class="container py-4">
        <div class="text-center mb-4">
            <h2 class="fw-bold mb-2" style="color: #1a2a3a; font-size: 1.8rem;">Open Positions</h2>
            <div style="width: 40px; height: 2px; background: #cbd5e0; margin: 0 auto;"></div>
            <p class="text-muted mt-2" style="font-size: 0.85rem;">Click the download icon to view the full job description</p>
        </div>
        ...
        <div class="table-responsive">
            <table class="jobs-table">
                ...
                <tbody>
                    ...
                    <!-- Job 1: Project Coordinator 
                    <tr>
                        <td><span class="job-title-text">Project Coordinator</span></td>
                        <td><span class="job-date">July 15, 2026</span></td>
                        <td><span class="job-date">Aug 15, 2026</span></td>
                        <td class="action-cell">
                            <a href="files/advert1.pdf" class="btn-download" target="_blank">
                                <i class="bi bi-download"></i>
                            </a>
                        </td>
                    </tr>

                    <!-- Job 2: Project Officers 
                    <tr>
                        <td><span class="job-title-text">Project Officers</span></td>
                        <td><span class="job-date">July 15, 2026</span></td>
                        <td><span class="job-date">Aug 15, 2026</span></td>
                        <td class="action-cell">
                            <a href="files/advert1.pdf" class="btn-download" target="_blank">
                    ...
                    <!-- Job 3: ICT Officer
                    <tr>
                        <td><span class="job-title-text">ICT Officer</span></td>
                        <td><span class="job-date">July 15, 2026</span></td>
                        <td><span class="job-date">Aug 15, 2026</span></td>
                        <td class="action-cell">
                            <a href="files/advert1.pdf" class="btn-download" target="_blank">
                    ...
                    <!-- Job 4: Accountants
                    <tr>
                        <td><span class="job-title-text">Accountants</span></td>
                        <td><span class="job-date">July 15, 2026</span></td>
                        <td><span class="job-date">Aug 15, 2026</span></td>
                        <td class="action-cell">
                            <a href="files/advert1.pdf" class="btn-download" target="_blank">
                    ...
                    <!-- Job 5: Monitoring & Evaluation Officer
                    <tr>
                        <td><span class="job-title-text">Monitoring & Evaluation Officer</span></td>
                        <td><span class="job-date">July 15, 2026</span></td>
                        <td><span class="job-date">Aug 15, 2026</span></td>
                        <td class="action-cell">
                            <a href="files/advert1.pdf" class="btn-download" target="_blank">
                    ...
                    <!-- Job 6: Interns
                    <tr>
                        <td><span class="job-title-text">Interns</span></td>
                        <td><span class="job-date">July 15, 2026</span></td>
                        <td><span class="job-date">Aug 15, 2026</span></td>
                        <td class="action-cell">
                            <a href="files/ads.pdf" class="btn-download" target="_blank">
                                <i class="bi bi-download"></i>
                            </a>
                        </td>
                    </tr>
...
<!-- Closed / Past Opportunities Section -->
<div id="closed-positions" class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.3s" style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%);">
    <div class="container py-5">
        <div class="text-center mb-5 mx-auto" style="max-width: 700px;">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">Closed Positions</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 40px; height: 2px; background: #cbd5e0;"></div>
            <p class="text-muted" style="color: #6c757d;">Recently concluded recruitments</p>
        </div>
        ...
        <div class="table-responsive">
            <table class="closed-table">
                ...
                <tbody id="closedPositionsBody">
                    <!-- Closed positions will be dynamically inserted here -->
                </tbody>
            </table>
        </div>
    </div>
...
<div id="guidelines" class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.4s" style="background: #f8f9fa;">
    <div class="container py-5">
        <div class="text-center mb-5 mx-auto" style="max-width: 700px;">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">Our Commitment to Fair & Transparent Hiring</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 40px; height: 2px; background: #cbd5e0;"></div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="guideline-card">
                    ...
                    <p>ADS–Nyanza is an equal opportunity employer committed to diversity and inclusion.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="guideline-card">
                    ...
                    <p>All applications must be submitted before the closing date. Only shortlisted candidates will be contacted.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="guideline-card">
                    ...
                    <h4>Recruitment Integrity</h4>
                    <p>Confidentiality and professionalism maintained throughout. Canvassing leads to automatic disqualification.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="guideline-card">
                    ...
                    <p>Keep visiting for upcoming opportunities with ADS–Nyanza.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="guideline-card">
                    ...
                    <p>For recruitment-related inquiries, please contact our HR department via email.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="guideline-card">
                    ...
                    <h4>Career Growth</h4>
                    <p>We invest in employees through training, mentorship, and professional development.</p>
                </div>
            </div>
        </div>
    </div>
...
function renderClosedPositions() {
    ...
    if (closedPositions.length === 0) {
        tbody.innerHTML = `
            <tr>
                <td colspan="3" class="text-center py-4 text-muted">No past positions available</td>
            </tr>
        `;
        return;
    }
    
    tbody.innerHTML = closedPositions.map(job => `
        <tr>
            <td>${job.title}</td>
            <td>${job.closingDate}</td>
            <td><span class="status-badge closed">${job.status}</span></td>
        </tr>
    `).join('');
}

function updateCounters() {
    document.getElementById('openCount').innerText = openPositions.length;
    document.getElementById('closedCount').innerText = closedPositions.length;
    document.getElementById('totalCount').innerText = openPositions.length + closedPositions.length;
}

function animateCounters() {
    animateValue('openCount', 0, openPositions.length, 1000);
    animateValue('closedCount', 0, closedPositions.length, 1000);
    animateValue('totalCount', 0, openPositions.length + closedPositions.length, 1000);
}

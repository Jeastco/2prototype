...
<head>
    ...
    <base href="/updated/">
    <meta charset="utf-8">
    <title>ADS Nyanza - Testimonials</title>
...
<!--End--><!-- ====== START: Testimonials Section with Bootstrap Carousel ====== -->
<section id="testimonials" class="bg-light py-5">
    <div class="container py-5">
        ...
        <div class="text-center mb-5" style="max-width: 700px; margin: 0 auto;">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">What Our Partners & Communities Say</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
            <p class="text-muted">Real voices from the field — sharing experiences on collaboration, impact, and transformation with ADS Nyanza.</p>
        </div>
        ...
        <div id="testimonialCarousel" class="carousel slide d-md-none" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="testimonial-card-mobile">
                        <div class="testimonial-author">
                            <img src="img/test1.jpg" alt="Jane Adhiambo" class="testimonial-avatar-large">
                            <div>
                                <h6 class="testimonial-name">Jane Adhiambo</h6>
                                <p class="testimonial-location">Uriri Sub-County</p>
                            </div>
                        </div>
                        <i class="bi bi-quote testimonial-quote"></i>
                        <p class="testimonial-text">
                            "Through ADS Nyanza's support, my children are getting access to quality education and nutritious food. The program has transformed our family's future."
                        </p>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card-mobile">
                        <div class="testimonial-author">
                            <img src="img/testimony-male.jpg" alt="John" class="testimonial-avatar-large">
                            <div>
                                <h6 class="testimonial-name">John</h6>
                                <p class="testimonial-location">Male Caregiver – Vihiga</p>
                            </div>
                        </div>
                        <i class="bi bi-quote testimonial-quote"></i>
                        <p class="testimonial-text">
                            "The training and guidance from ADS Nyanza have helped me create a nurturing environment where every child feels loved, valued, and supported."
                        </p>
                        <div class="testimonial-rating">
                            <i class="bi bi-star-fill"></i>
                            <i class="bi bi-star-fill"></i>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card-mobile">
                        <div class="testimonial-author">
                            <img src="img/testimonal1.jpg" alt="Elizabeth Moraa" class="testimonial-avatar-large">
                            <div>
                                <h6 class="testimonial-name">Elizabeth Moraa</h6>
                                <p class="testimonial-location">ECD Beneficiary – Nyamira</p>
                            </div>
                        </div>
                        <i class="bi bi-quote testimonial-quote"></i>
                        <p class="testimonial-text">
                            "The ECD program has truly improved my child's growth and given me confidence as a mother through proper nutrition guidance and support."
                        </p>
                        <div class="testimonial-rating">
                            <i class="bi bi-star-fill"></i>
                            <i class="bi bi-star-fill"></i>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card-mobile">
                        <div class="testimonial-author">
                            <img src="img/ecd_elizabeth.jpg" alt="Mary Atieno" class="testimonial-avatar-large">
                            <div>
                                <h6 class="testimonial-name">Mary Atieno</h6>
                                <p class="testimonial-location">Community Health Worker – Kisumu</p>
                            </div>
                        </div>
                        <i class="bi bi-quote testimonial-quote"></i>
                        <p class="testimonial-text">
                            "Working alongside ADS Nyanza has empowered me to serve my community better. The training and resources provided have been invaluable."
                        </p>
                        <div class="testimonial-rating">
                            <i class="bi bi-star-fill"></i>
                            <i class="bi bi-star-fill"></i>
            ...
            <div class="carousel-controls">
                <button class="carousel-btn prev" data-bs-target="#testimonialCarousel" data-bs-slide="prev">
                    <i class="bi bi-chevron-left"></i>
                </button>
                <button class="carousel-btn next" data-bs-target="#testimonialCarousel" data-bs-slide="next">
        ...
        <div class="row g-4 justify-content-center d-none d-md-flex mt-2">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="testimonial-card">
                    ...
                    <i class="bi bi-quote testimonial-quote"></i>
                    <p class="testimonial-text">
                        "Through ADS Nyanza's support, my children are getting access to quality education and nutritious food. The program has transformed our family's future and given us hope."
                    </p>
                    <div class="testimonial-rating">
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="testimonial-card">
                    ...
                    <i class="bi bi-quote testimonial-quote"></i>
                    <p class="testimonial-text">
                        "The training and guidance from ADS Nyanza have helped me create a nurturing environment where every child feels loved, valued, and supported to reach their full potential."
                    </p>
                    <div class="testimonial-rating">
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="testimonial-card">
                    ...
                    <i class="bi bi-quote testimonial-quote"></i>
                    <p class="testimonial-text">
                        "The ECD program has truly improved my child's growth and given me confidence as a mother through proper nutrition guidance and continuous support."
                    </p>
                    <div class="testimonial-rating">
                        <i class="bi bi-star-fill"></i>
                        <i class="bi bi-star-fill"></i>
...
/* Large Avatar - Clear and Visible */

...
<head>
    ...
    <base href="/updated/">
    <meta charset="utf-8">
    <title>ADS Nyanza - Gallery</title>
...
<!-- ================= MODERN PHOTO GALLERY & VIDEO SHOWCASE SECTION ================= -->

<section id="gallery-section" class="gallery-section">
    <div class="container">

        <div class="section-header text-center">
            <span class="section-badge">OUR VISUAL STORY</span>
            <h2 class="section-title-main">Moments of Impact</h2>
            <p class="section-subtitle">Capturing transformation moments across our communities</p>
        </div>

        <div class="filter-wrapper">
            <div class="filter-container">
                <button class="filter-btn active" data-filter="all">All Projects</button>
                <button class="filter-btn" data-filter="ecd">Early Childhood Development</button>
                <button class="filter-btn" data-filter="pesp">Peoples Empowerment for Sustainability</button>
                <button class="filter-btn" data-filter="icrp">Integrated Climate Resilience</button>
                <button class="filter-btn" data-filter="kaleidoscope">Kaleidoscope</button>
                <button class="filter-btn" data-filter="globalfund">Global Fund</button>
                <button class="filter-btn" data-filter="wkpi">West Kenya Peace Initiative</button>
        ...
        <div class="gallery-grid" id="galleryGrid">
            ...
            <!-- 1. ECD -->
            <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/ecd/1.jpg" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm6.jpg" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm7.jpg" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm8.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
             <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm9.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm10.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
            ...
            <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm11.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
             <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm12.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
             <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm13.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
             <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm14.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
             <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mtm15.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
             <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/ecd11.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
             <div class="gallery-item" data-category="ecd">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/ecd1213.png" alt="ECD Activity" class="gallery-img">
                    </div>
                </div>
            </div>
            ...
            <!-- 2. PESP -->
              <div class="gallery-item" data-category="pesp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/pesp11.jpg" alt="PESP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="pesp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/pesp12.jpg" alt="PESP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="pesp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/pesp13.png" alt="PESP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="pesp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/pesp14.png" alt="PESP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="pesp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/pesp15.png" alt="PESP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="pesp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/pesp16.png" alt="PESP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="pesp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/pesp17.png" alt="PESP" class="gallery-img">
                    </div>
                </div>
            </div>
          
            <!-- 3. ICRP -->
              <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp11.jpeg" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp12.jpeg" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp13.jpg" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp14.png" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp15.png" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp16.png" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp17.png" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>   
            <div class="gallery-item" data-category="icrp">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/icrp18.png" alt="ICRP" class="gallery-img">
                    </div>
                </div>
            </div>  

            <!-- 4. Kaleidoscope -->
             <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/kalido1.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>  
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/kalido2.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>  
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/kalido3.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>  
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/kalido4.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>  
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/kalido5.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>  
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/kalido6.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div> 
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/kscope1.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mohkaliedo.PNG" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/mohkaliedo1.PNG" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div>  
             <div class="gallery-item" data-category="kaleidoscope">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/westpokot1.png" alt="SRHR Advocacy" class="gallery-img">
                    </div>
                </div>
            </div> 
            
            <!-- 5. Global Fund -->
             <div class="gallery-item" data-category="globalfund">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/gf1.png" alt="Global Fund" class="gallery-img">
                    </div>
                </div>
            </div> 
            <div class="gallery-item" data-category="globalfund">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/gf2.png" alt="Global Fund" class="gallery-img">
                    </div>
                </div>
            </div> 
            <div class="gallery-item" data-category="globalfund">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/gf3.png" alt="Global Fund" class="gallery-img">
                    </div>
                </div>
            </div> 
            <div class="gallery-item" data-category="globalfund">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/gf5.png" alt="Global Fund" class="gallery-img">
                    </div>
                </div>
            </div>

            <!-- 6. WKPI -->
             <div class="gallery-item" data-category="wkpi">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/wkpi20.JPG" alt="WKPI" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="wkpi">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/wkpi21.JPG" alt="WKPI" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="wkpi">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/wkpi23.JPG" alt="WKPI" class="gallery-img">
                    </div>
                </div>
            </div>
            ...
            <!-- 7. Emergency Response -->
              <div class="gallery-item" data-category="emergency">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/emerg1.jpg" alt="Emergency Response" class="gallery-img">
                    </div>
                </div>
            </div>
            <div class="gallery-item" data-category="emergency">
                <div class="gallery-card">
                    <div class="gallery-image-wrapper">
                        <img src="img/emerg2.jpg" alt="Emergency Response" class="gallery-img">
                    </div>
                </div>
            </div>
        </div>
...
<section class="video-section">
    <div class="container">
        ...
        <div class="section-header text-center">
            ...
            <h2 class="section-title-main">Our Impact in Motion</h2>
            <p class="section-subtitle">Stories of transformation through our community development programs</p>
        </div>
        ...
        <div class="video-grid">
            ...
            <div class="video-card">
                <div class="video-thumbnail">
                    ...
                    <a href="https://www.youtube.com/watch?v=J3LMDVNCs5c" target="_blank" class="video-link-overlay">
                        <i class="fas fa-play"></i>
                    </a>
                </div>
                <div class="video-info">
                    <h4>Moments That Matter (MTM)</h4>
                    <p>Transforming early childhood education through nurturing care and parental engagement across Nyanza region.</p>
                    <div class="video-meta">
                        <span><i class="fas fa-clock"></i> 4:32 min</span>
                        <span class="watch-btn">Watch Story <i class="fas fa-arrow-right"></i></span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                <div class="video-thumbnail">
                    <div class="thumbnail-placeholder">
                        ...
                        <span>Savings with Education</span>
                    </div>
                    <a href="https://www.youtube.com/watch?v=XhzUOKvp_bQ" target="_blank" class="video-link-overlay">
                        <i class="fas fa-play"></i>
                    </a>
                </div>
                <div class="video-info">
                    <h4>Savings with Education (SWE)</h4>
                    <p>Empowering families through financial literacy and sustainable livelihood development in rural communities.</p>
                    <div class="video-meta">
                        <span><i class="fas fa-clock"></i> 5:18 min</span>
                        <span class="watch-btn">Watch Story <i class="fas fa-arrow-right"></i></span>
                    </div>
                </div>
            </div>
            ...
            <div class="video-card">
                <div class="video-thumbnail">
                    <div class="thumbnail-placeholder">
                        ...
                        <span>Kaleidoscope Project</span>
                    </div>
                    <a href="https://www.youtube.com/watch?v=zKjaM_7yFDM" target="_blank" class="video-link-overlay">
                        <i class="fas fa-play"></i>
                    </a>
                </div>
                <div class="video-info">
                    <h4>Kaleidoscope Project Launch</h4>
                    <p>Signing of MOU at Samburu County Referral Hospital - advancing SRHR for women and adolescent girls.</p>
                    <div class="video-meta">
                        <span><i class="fas fa-clock"></i> 3:45 min</span>
                        <span class="watch-btn">Watch Story <i class="fas fa-arrow-right"></i></span>
                    </div>
                </div>
            </div>
...
<style>
    ...
    .filter-btn:nth-child(1) { --i: 1; }
    .filter-btn:nth-child(2) { --i: 2; }
    .filter-btn:nth-child(3) { --i: 3; }
    .filter-btn:nth-child(4) { --i: 4; }
    .filter-btn:nth-child(5) { --i: 5; }
    .filter-btn:nth-child(6) { --i: 6; }
    .filter-btn:nth-child(7) { --i: 7; }
    .filter-btn:nth-child(8) { --i: 8; }
    ...
    .gallery-item {
        transition: all 0.3s ease;
        animation: galleryReveal 0.6s cubic-bezier(0.2, 0.9, 0.4, 1.1) both;
    ...
    .video-card {
        ...
        box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08);
        transition: all 0.4s cubic-bezier(0.2, 0.9, 0.4, 1.1);
        animation: videoReveal 0.7s ease-out backwards;
        animation-delay: calc(0.1s * var(--video-index, 0));
    }

    .video-card:nth-child(1) { --video-index: 1; }
    .video-card:nth-child(2) { --video-index: 2; }
    .video-card:nth-child(3) { --video-index: 3; }
    ...
    .video-thumbnail:hover .video-link-overlay {
        opacity: 1;
    ...
    .gallery-item.revealed, .video-card.revealed {
...
<script>
    (function() {
        ...
        // Image lazy loading with shimmer removal
        ...
        const revealElements = document.querySelectorAll('.gallery-item, .video-card');
        ...
        // Set animation delays for gallery items dynamically
        ...
        // Add hover ripple effect to filter buttons (optional visual enhancement)
        filterBtns.forEach(btn => {
...
<!-- ================= END: PHOTO GALLERY & VIDEO SHOWCASE SECTION ================= -->

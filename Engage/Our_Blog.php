...
<head>
    ...
    <base href="/updated/">
    <meta charset="utf-8">
    <title>ADS Nyanza - Our Blog</title>
...
<section id="blog-journal" class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
    <div class="container py-4">
        ...
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">Stories of Change & Impact</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
            <p class="text-muted mx-auto" style="max-width: 600px;">Real stories from the communities we serve, capturing moments of transformation and hope</p>
        </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/erd1.jpg" alt="Caroline and baby Marion" class="blog-img">
                                <span class="blog-category">#storiesoflastingchange</span>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <span><i class="bi bi-person-fill"></i> Caroline and baby Marion</span>
                                </div>
                                <h4 class="blog-title">Moments that Matter</h4>
                                <p class="blog-excerpt">Our journey of lasting change in the lives of children and families.</p>
                                <a href="https://www.facebook.com/share/p/1FtYfFeCjP/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/erd2.jpg" alt="Savings with Education" class="blog-img">
                                <span class="blog-category">#SavingswithEducation</span>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <span><i class="bi bi-person-fill"></i> Episcopal Relief & Development</span>
                                </div>
                                <h4 class="blog-title">Economic Opportunities</h4>
                                <p class="blog-excerpt">Impact is always greater when we work together.</p>
                                <a href="https://www.facebook.com/share/p/1hmSwXprcM/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/nina.PNG" alt="Nina Orero" class="blog-img">
                                <span class="blog-category">#episcopal_relief</span>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <span><i class="bi bi-person-fill"></i> Nina Orero</span>
                                </div>
                                <h4 class="blog-title">Program Partner</h4>
                                <p class="blog-excerpt">Our Global Community: Faces of Change</p>
                                <a href="https://www.instagram.com/p/DM738hgoQnZ/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/blog2.png" alt="Early Childhood Development" class="blog-img">
                                <span class="blog-category">#babahood</span>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <span><i class="bi bi-person-fill"></i> Early Childhood Development</span>
                                </div>
                                <h4 class="blog-title">Nation-Gender</h4>
                                <p class="blog-excerpt">The manual that could heal a generation</p>
                                <a href="https://www.instagram.com/p/DOIo0vPCFuq/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/blog4.png" alt="Kaleidoscope Project" class="blog-img">
                                <span class="blog-category">#Kaleidoscope</span>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <span><i class="bi bi-person-fill"></i> Kaleidoscope Project</span>
                                </div>
                                <h4 class="blog-title">Joint Session</h4>
                                <p class="blog-excerpt">By working together intentionally, we can build responsive, inclusive, and sustainable solutions.</p>
                                <a href="https://www.instagram.com/p/DPeD2aqiDQa/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/blog5.jpg" alt="Moments That Matter" class="blog-img">
                                <span class="blog-category">#MomentsthatMatter</span>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <span><i class="bi bi-person-fill"></i> Moments That Matter®</span>
                                </div>
                                <h4 class="blog-title">The Story of Awiti</h4>
                                <p class="blog-excerpt">By working together intentionally, we can build responsive, inclusive, and sustainable solutions.</p>
                                <a href="https://www.facebook.com/share/p/17DXzqbETg/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/blog6.jpg" alt="The Girl Child Day" class="blog-img">
                                <span class="blog-category">#girlchildday</span>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <span><i class="bi bi-person-fill"></i> The Girl Child Day</span>
                                </div>
                                <h4 class="blog-title">The Girl I Am, The Change I Lead</h4>
                                <p class="blog-excerpt">Girls on the Frontlines of Crisis celebrating the courage, leadership, and unstoppable power of girls shaping a better tomorrow.</p>
                                <a href="https://www.facebook.com/share/p/1J7cEEaGC4/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="blog-card">
                            <div class="blog-image-wrapper">
                                <img src="img/blog7.jpg" alt="Young Mothers Program" class="blog-img">
                            ...
                            <div class="blog-content">
                                ...
                                <h4 class="blog-title">Young Mothers</h4>
                                <p class="blog-excerpt">Elizabeth learned the importance of positive discipline, play and care for her young child.</p>
                                <a href="https://www.facebook.com/share/p/19zAnBT3G4/" class="blog-link" target="_blank">Read More <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <!-- Categories -->
                <div class="sidebar-card wow fadeInUp" data-wow-delay="0.2s">
                    <h4 class="sidebar-title">Categories</h4>
                    <ul class="category-list">
                        <li><a href="index"><i class="bi bi-house-door"></i> Home</a></li>
                        <li><a href="About_Us"><i class="bi bi-info-circle"></i> About Us</a></li>
                        <li><a href="events"><i class="bi bi-calendar-event"></i> Our Events</a></li>
                        <li><a href="Engage/publications"><i class="bi bi-journal"></i> Our Publications</a></li>
                        <li><a href="Engage/donate"><i class="bi bi-heart"></i> Donate Now</a></li>
                        <li><a href="Engage/volunteer"><i class="bi bi-person-heart"></i> Volunteer</a></li>
                    </ul>
                </div>

                <!-- Recent Posts - Now with working links to blog posts -->
                <div class="sidebar-card wow fadeInUp" data-wow-delay="0.3s">
                    <h4 class="sidebar-title">Recent Posts</h4>
                    
                    <div class="recent-post">
                        <img src="img/west1.PNG" alt="Kaleidoscope Project">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Maternal Health</span>
                            <a href="#">Kaleidoscope Project: Transforming Maternal Health</a>
                        </div>
                    </div>

                    <div class="recent-post">
                        <img src="img/env.png" alt="World Environment Day">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Climate Action</span>
                            <a href="#">Faith in Action: Planting Trees, Cleaning Communities</a>
                        </div>
                    </div>

                    <div class="recent-post">
                        <img src="img/lucy11.png" alt="Lucy and Reagan">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Family Transformation</span>
                            <a href="#">From Fear to Peace: Lucy & Reagan's Story</a>
                        </div>
                    </div>

                    <div class="recent-post">
                        <img src="img/keto.jpeg" alt="Keto Mise Caregiver Group">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Caregiver Success</span>
                            <a href="#">Inspiring Change: Keto Mise Caregiver Group</a>
                        </div>
                    </div>

                    <div class="recent-post">
                        <img src="img/agriweek.jpg" alt="Agricultural Week">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Agriculture</span>
                            <a href="#">Together We Grow: National Agricultural Week</a>
                        </div>
                    </div>

                    <div class="recent-post">
                        <img src="img/14.jpeg" alt="Bishop Consecration">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Church Event</span>
                            <a href="#">Consecration & Enthronement of Bishop Benard Enos Otieno Owuor</a>
                        </div>
                    </div>

                    <div class="recent-post">
                        <img src="img/ecdcounty1.jpeg" alt="ECDE Summit">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Early Childhood</span>
                            <a href="#">ECDE Partner Summit: Progress in Kisumu</a>
                        </div>
                    </div>

                    <div class="recent-post">
                        <img src="img/nairobi_aids.jpg" alt="World AIDS Day">
                        <div class="recent-post-info">
                            <span class="recent-category"><i class="bi bi-tag-fill"></i> Health</span>
                            <a href="#">World AIDS Day: Running for Hope</a>
                        </div>
                    </div>
                </div>

                <!-- Featured Image -->
                <div class="sidebar-card text-center wow fadeInUp" data-wow-delay="0.4s">
                    <img src="img/mtm4.png" alt="Moments That Matter" class="img-fluid rounded w-100">
                </div>

                <!-- Our Projects -->
                <div class="sidebar-card wow fadeInUp" data-wow-delay="0.5s">
                    <h4 class="sidebar-title">Our Projects</h4>
                ...
                <!-- About ADS Nyanza -->
                <div class="sidebar-card about-card wow fadeInUp" data-wow-delay="0.6s">
                    <h4 class="sidebar-title">About ADS Nyanza</h4>
                    <p>ADS Nyanza is a Christian faith-based organization committed to empowering communities in Western Kenya. Through our various programs in early childhood development, climate resilience, peace initiatives, and emergency response, we work to create lasting positive change and sustainable development.</p>
                    <a href="About_Us" class="about-btn">Learn More <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
            <!-- Sidebar End -->
        </div>
...
.recent-post-info .recent-category {
    font-size: 0.6rem;
    font-weight: 600;
    color: #2e7d32;
    display: flex;
...
.recent-post-info .recent-category i {
    font-size: 0.5rem;
}

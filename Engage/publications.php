...
<head>
    ...
    <base href="/updated/">
    <meta charset="utf-8">
    <title>ADS NYANZA - Publications</title>
...
<section id="publications" style="padding: 80px 0; background: #ffffff; overflow: hidden;">
    <div class="container" style="max-width: 1280px; margin: 0 auto; padding: 0 24px;">
        
        <!-- Section Header -->
        <div style="text-align: center; margin-bottom: 56px;">
            <span style="display: inline-block; font-size: 0.65rem; font-weight: 700; letter-spacing: 3px; text-transform: uppercase; color: #2e7d32; background: rgba(46,125,50,0.06); padding: 6px 20px; border-radius: 100px; margin-bottom: 14px;">
                📄 Our Publications
            </span>
            <h2 style="font-family: 'Playfair Display', serif; font-size: 2.6rem; font-weight: 700; color: #1a2a3a; margin-bottom: 10px; letter-spacing: -0.5px;">
                Insights, Features & Thought Leadership
            </h2>
            <div style="width: 70px; height: 3px; background: linear-gradient(90deg, #2e7d32, #66bb6a); margin: 14px auto 20px; border-radius: 4px;"></div>
            <p style="color: #6b7a8f; max-width: 650px; margin: 0 auto; font-size: 0.95rem; line-height: 1.7;">
                Explore our latest research publications, field updates, and professional articles shared across various media platforms.
            </p>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(350px, 1fr)); gap: 30px;">
            ...
            <div class="publication-card">
                <div class="publication-image">
                    <img src="img/pub2.jpg" alt="Strengthening Early Childhood Development" onerror="this.src='https://placehold.co/400x250/1a2a3a/white?text=ECD+Research'">
                    <span class="publication-badge" style="background: #2e7d32;">Research</span>
                </div>
                <div class="publication-content">
                    <div class="publication-meta">
                        <span><i class="bi bi-calendar3"></i> October 2025</span>
                        <span><i class="bi bi-geo-alt"></i> Nyamira County</span>
                    </div>
                    <h4 class="publication-title">Strengthening Early Childhood Development Through Community Dialogue</h4>
                    <p class="publication-excerpt">Insights from ADS Nyanza's Research Dissemination Forums on early childhood development strategies and community engagement.</p>
                    <div class="publication-footer">
                        <a href="https://www.linkedin.com/pulse/strengthening-early-childhood-development-through-community-nyanza-bmh0f" target="_blank" class="publication-link">
                            Read More <i class="bi bi-arrow-right"></i>
                        </a>
                        <span class="publication-platform"><i class="bi bi-linkedin"></i> LinkedIn</span>
                    </div>
                </div>
            </div>
            ...
            <div class="publication-card">
                <div class="publication-image">
                    <img src="img/pub1.png" alt="Celebrating Customer Service Week" onerror="this.src='https://placehold.co/400x250/1a2a3a/white?text=Customer+Service'">
                    <span class="publication-badge" style="background: #1565c0;">Feature</span>
                </div>
                <div class="publication-content">
                    <div class="publication-meta">
                        <span><i class="bi bi-calendar3"></i> October 2025</span>
                        <span><i class="bi bi-tag"></i> Customer Service Week</span>
                    </div>
                    <h4 class="publication-title">Celebrating Customer Service Week: A Story of Empowerment</h4>
                    <p class="publication-excerpt">A story of empowerment in Siaya County – celebrating dedication, service excellence, and community impact.</p>
                    <div class="publication-footer">
                        <a href="https://www.linkedin.com/posts/ads-nyanza_customerserviceweek-adsnyanza-communityempowerment-activity-7381633082329579520-S1Sp" target="_blank" class="publication-link">
                            Read More <i class="bi bi-arrow-right"></i>
                        </a>
                        <span class="publication-platform"><i class="bi bi-linkedin"></i> LinkedIn</span>
                    </div>
            ...
            <div class="publication-card">
                <div class="publication-image">
                    <img src="img/pub3.jpg" alt="Moments that Matter through ECD" onerror="this.src='https://placehold.co/400x250/1a2a3a/white?text=Moments+that+Matter'">
                    <span class="publication-badge" style="background: #e65100;">Featured</span>
                </div>
                <div class="publication-content">
                    <div class="publication-meta">
                        <span><i class="bi bi-calendar3"></i> September 2025</span>
                        <span><i class="bi bi-star-fill" style="color: #f5a623;"></i> Featured</span>
                    </div>
                    <h4 class="publication-title">Moments that Matter through ECD</h4>
                    <p class="publication-excerpt">Effective strategies for male engagement in nurturing care for early childhood development programs and family strengthening.</p>
                    <div class="publication-footer">
                        <a href="https://www.facebook.com/share/p/1MsxisD3C4/" target="_blank" class="publication-link">
                            Read More <i class="bi bi-arrow-right"></i>
                        </a>
                        <span class="publication-platform"><i class="bi bi-facebook"></i> Facebook</span>
                    </div>
                </div>
            </div>
            ...
            <div class="publication-card">
                <div class="publication-image">
                    <img src="img/pub4.jpg" alt="Moments that Matter" onerror="this.src='https://placehold.co/400x250/1a2a3a/white?text=Elizabeth+Story'">
                    <span class="publication-badge" style="background: #6a1b9a;">Partner Feature</span>
                </div>
                <div class="publication-content">
                    <div class="publication-meta">
                        <span><i class="bi bi-calendar3"></i> September 2025</span>
                        <span><i class="bi bi-handshake"></i> Partner Feature</span>
                    </div>
                    <h4 class="publication-title">Moments that Matter: Elizabeth's Journey</h4>
                    <p class="publication-excerpt">Elizabeth's journey from doubt to confidence shows the power of support and community in early childhood development.</p>
                    <div class="publication-footer">
                        <a href="https://www.linkedin.com/posts/ads-nyanza_episcopalrelief-activity-7368928108357267456-BXLg" target="_blank" class="publication-link">
                            Read More <i class="bi bi-arrow-right"></i>
                        </a>
                        <span class="publication-platform"><i class="bi bi-linkedin"></i> LinkedIn</span>
                    </div>
            ...
            <div class="publication-card">
                <div class="publication-image">
                    <img src="img/pub5.jpg" alt="Climate Action in Western Kenya" onerror="this.src='https://placehold.co/400x250/1a2a3a/white?text=Climate+Action'">
                    <span class="publication-badge" style="background: #00897b;">Climate</span>
                </div>
                <div class="publication-content">
                    <div class="publication-meta">
                        <span><i class="bi bi-calendar3"></i> August 2025</span>
                        <span><i class="bi bi-tree"></i> Environment</span>
                    </div>
                    <h4 class="publication-title">Climate Action: Planting Trees, Growing Hope in Western Kenya</h4>
                    <p class="publication-excerpt">How ADS Nyanza is mobilizing communities for climate resilience through tree planting and sustainable agriculture initiatives.</p>
                    <div class="publication-footer">
                        <a href="#" target="_blank" class="publication-link">
                            Read More <i class="bi bi-arrow-right"></i>
                        </a>
                        <span class="publication-platform"><i class="bi bi-globe"></i> Website</span>
                    </div>
                </div>
            </div>
            ...
            <div class="publication-card">
                <div class="publication-image">
                    <img src="img/pub6.jpg" alt="Maternal Health" onerror="this.src='https://placehold.co/400x250/1a2a3a/white?text=Maternal+Health'">
                    <span class="publication-badge" style="background: #c62828;">Health</span>
                </div>
                <div class="publication-content">
                    <div class="publication-meta">
                        <span><i class="bi bi-calendar3"></i> July 2025</span>
                        <span><i class="bi bi-heart-pulse"></i> Maternal Health</span>
                    </div>
                    <h4 class="publication-title">Strengthening Maternal Health Systems in West Pokot</h4>
                    <p class="publication-excerpt">The Kaleidoscope Project's impact on reducing maternal deaths and improving healthcare access for women and adolescent girls.</p>
                    <div class="publication-footer">
                        <a href="#" target="_blank" class="publication-link">
                            Read More <i class="bi bi-arrow-right"></i>
                        </a>
        ...
        <div style="text-align: center; margin-top: 48px;">
            <a href="https://www.linkedin.com/in/ads-nyanza/" target="_blank" class="btn-view-all">
...
.publication-platform .bi-linkedin {
    color: #0a66c2;
}

.publication-platform .bi-facebook {
    color: #1877f2;
}

.publication-platform .bi-globe {
    color: #2e7d32;
}
...
.btn-view-all {
    ...
    text-decoration: none;
    transition: all 0.3s ease;
    box-shadow: 0 5px 25px rgba(26,42,58,0.15);
    border: none;
    cursor: pointer;
}
...
.btn-view-all:hover {
    ...
    box-shadow: 0 12px 35px rgba(26,42,58,0.25);
    gap: 16px;
}

        ...
        <div class="row g-5 align-items-start">
            ...
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-4">
                    ...
                    <h1 class="mb-3" style="color: #1a2a3a;">Our History and Growth</h1>
                    <div class="rounded-pill" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
                </div>
                
                <p class="mb-3" style="line-height: 1.8; color: #555;">
                    The organization traces its history to <strong class="text-success">1975</strong>, when the then ACK Diocese of Maseno South launched an 
                    Integrated Rural Development Program (IRDP) as a means through which it promoted 
                    community health initiatives, food production, and appropriate technology and education programs.
                </p>
                
                <p class="mb-3" style="line-height: 1.8; color: #555;">
                    In <strong class="text-success">1981</strong>, the then Church of Province of Kenya (CPK) established a 
                    Provincial Board of Christian Community Services (PBCCS) that initiated a church 
                    development consultative meeting, which largely focused on expansion of the church ministry, 
                    around May 1983. The ministry was to cater for rural and urban poor by precipitating development 
                    and established provincial diocesan office and development offices (Christian Community Services (CCS)).
                </p>
                
                <p class="mb-3" style="line-height: 1.8; color: #555;">
                    It was also charged with developing critical awareness about what was happening to the people. 
                    As a result, CCS became the development arm of the church focusing on program development and 
                    service delivery. The integration of various Diocesan Development Departments into broader 
                    regional development platforms led to the formation of the 
                    <strong class="text-success">Inter Diocesan Christian Community Services (IDCCS) in 1997</strong> 
                    that later rebranded to <strong class="text-success">ADS–Nyanza in 2010</strong>.
                </p>
                
                <p class="mb-0" style="line-height: 1.8; color: #555;">
                    Since 1997, the organization has promoted transformational human development that stimulated 
                    equality in the sharing of the full benefits of God's abundant resources.
                </p>
            </div>
            ...
            <div class="col-lg-5">
                <div class="timeline-container">
                    <h4 class="text-center mb-4 fw-bold" style="color: #1a2a3a;">
                        <i class="bi bi-graph-up me-2" style="color: #2e7d32;"></i>
                    ...
                    <div class="timeline">
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <h5>Integrated Rural Development Program</h5>
                                <p>Launched by ACK Diocese of Maseno South</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            <div class="timeline-badge">1981</div>
                            <div class="timeline-content">
                                <h5>PBCCS Established</h5>
                                <p>Provincial Board of Christian Community Services</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            <div class="timeline-badge">1983</div>
                            <div class="timeline-content">
                                <h5>Christian Community Services</h5>
                                <p>Became development arm of the church</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <h5>IDCCS Created</h5>
                                <p>Inter Diocesan Christian Community Services</p>
                            </div>
                        </div>
                        <div class="timeline-item">
                            <div class="timeline-badge">2010</div>
                            <div class="timeline-content">
                                <h5>ADS–Nyanza Rebrand</h5>
                                <p>Continuing transformative community development</p>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Impact Stats with Auto-Counting -->
                    <div class="impact-stats mt-4">
                        <div class="row g-3 text-center">
                            ...
                            <div class="col-4">
                                <div class="stat-circle">
                                    <span class="stat-number" id="livesCount">0</span>
                                    <span class="stat-label">Lives Impacted</span>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="stat-circle">
                                    <span class="stat-number" id="countiesCount">0</span>
...
/* Impact Stats */
.impact-stats {
    background: linear-gradient(135deg, #1a2a3a 0%, #2e7d32 100%);
    border-radius: 16px;
    padding: 1.25rem;
}
...
<script>
// Auto-calculate and animate years from 1997
function animateYears() {
    ...
    const counter = setInterval(() => {
        ...
        if (currentCount >= targetCount) {
            document.getElementById('yearsCount').innerText = targetCount;
            clearInterval(counter);
        } else {
            document.getElementById('yearsCount').innerText = Math.floor(currentCount);
        }
    }, 16);
}

// Animate lives impacted - 2 Million+
function animateLives() {
    const targetCount = 2.2;
    let currentCount = 0;
    const duration = 2500;
    const increment = targetCount / (duration / 16);
    ...
    const counter = setInterval(() => {
        currentCount += increment;
        if (currentCount >= targetCount) {
            document.getElementById('livesCount').innerText = '2.2M+';
            clearInterval(counter);
        } else {
            document.getElementById('livesCount').innerText = currentCount.toFixed(1) + 'M';
        }
    }, 16);
}

// Animate counties
function animateCounties() {
    const targetCount = 6;
    let currentCount = 0;
    const duration = 1500;
    const increment = targetCount / (duration / 16);
    ...
    const counter = setInterval(() => {
        currentCount += increment;
        if (currentCount >= targetCount) {
            document.getElementById('countiesCount').innerText = targetCount;
            clearInterval(counter);
        } else {
            document.getElementById('countiesCount').innerText = Math.floor(currentCount);
        }
    }, 16);
}

// Run all animations when page loads
...
<!-- About End -->
<!-- Our Approach Start -->
<div class="container-fluid py-5 bg-light wow fadeInUp" data-wow-delay="0.1s" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-5">
                <div class="approach-image">
                    <img class="img-fluid rounded shadow-lg" 
                         ...
                         alt="ADS Nyanza Approach" 
                         onerror="this.src='https://placehold.co/500x600/2e7d32/white?text=Our+Approach'">
                </div>
            </div>
            ...
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-4">
                    ...
                    <h1 class="mb-3" style="color: #1a2a3a;">How We Work With Communities</h1>
                    <div class="rounded-pill" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
                </div>

                <div class="mb-4">
                    <p class="mb-3" style="line-height: 1.8; color: #555;">
                        ADS Nyanza works in communities where there is a real need. Our aim is to facilitate 
                        independence, self-sufficiency, and dignity of life in the communities we serve. 
                        Our programs are bespoke to each community, reflecting local culture, economic, 
                        political, and environmental contexts.
                    </p>
                    <p class="mb-0" style="line-height: 1.8; color: #555;">
                        We focus on all aspects of community development — working to enable the communities 
                        to achieve fullness of life and uphold the integrity of creation through 
                ...
                <div class="row g-4 mt-2">
                    <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                        <div class="approach-step">
                            ...
                            <p>We identify communities in need.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                        <div class="approach-step">
                            ...
                            <h5>Validation</h5>
                            <p>We validate the 'need' and measure the change.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                        <div class="approach-step">
                            ...
                            <p>We develop long-term holistic programs within communities.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                        <div class="approach-step">
                            ...
                            <h5>Services</h5>
                            <p>We create community ownership and demand-driven services.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 wow fadeIn" data-wow-delay="0.6s">
                        <div class="approach-step">
                            ...
                            <h5>Growth</h5>
                            <p>We hand over and support community growth.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                        <div class="approach-step">
                            ...
                            <h5>Engagement</h5>
                            <p>We engage, nurture, and maintain volunteers and partners.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Bootstrap Icons (already included, but ensure it's there) -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
<!-- Our Approach End -->
<!-- Thematic Areas Start -->
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="background: #ffffff;">
    <div class="container py-5">
        ...
        <div class="text-center mb-5 mx-auto" style="max-width: 700px;">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">Our Thematic Areas of Impact</h2>
        ...
        <div class="row g-5 align-items-center mb-5 pb-3">
            <div class="col-lg-6">
                <h3 style="color: hsl(140, 82%, 37%); font-weight: 700;">Early Childhood Development & Education</h3>
                <p style="line-height: 1.8; color: #555;">
                    We collaborate closely with communities and vulnerable households with children aged 0-3 years to promote nurturing care for early childhood development. Our focus is on fostering positive parenting practices, promoting social behavior change, and encouraging male involvement in caregiving roles.
                </p>
                <p style="line-height: 1.8; color: #555;">
                ...
                <p style="line-height: 1.8; color: #555;">
                    Additionally, we partner with consortia of faith leaders to enhance psychosocial support for caregivers and advocate for policies that prioritize early childhood development.
                </p>
            </div>
            <div class="col-lg-6">
                <img src="img/ecd/3.jpeg" class="img-fluid rounded shadow" alt="Early Childhood Development" style="width: 100%; height: 350px; object-fit: cover;" onerror="this.src='https://placehold.co/600x350/f0f0f0/999?text=ECD+Program'">
            </div>
        </div>

        <!-- Thematic Area 2 -->
        <div class="row g-5 align-items-center mb-5 pb-3 flex-lg-row-reverse">
            <div class="col-lg-6">
                <h3 style="color: hsl(140, 82%, 37%); font-weight: 700;">Health & Advocacy</h3>
                <p style="line-height: 1.8; color: #555;">
                    ADS-Nyanza is intervening for basic human right – health through promotive and preventive health for communities' wellbeing working in partnership with Government departments and relevant stakeholders. Our focus is on the most vulnerable populations including women, youths and HIV-affected communities.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Universal Health Coverage</strong> – Ensuring that women, youth, children and HIV-affected receive adequate and affordable health services by working closely with local health services providers and County departments.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Sexual and Reproductive Health and Rights (SRHR)</strong> – Increased access to quality SRHR information, services and enabling environment for youths.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Climate Change and Health</strong> – The organization monitors climate change related diseases e.g., malaria, malnutrition and partners for interventions.
                </p>
            </div>
            <div class="col-lg-6">
                <img src="img/wedo.jpg" class="img-fluid rounded shadow" alt="Health and Advocacy" style="width: 100%; height: 350px; object-fit: cover;" onerror="this.src='https://placehold.co/600x350/f0f0f0/999?text=Health+Program'">
            </div>
        </div>
        ...
        <div class="row g-5 align-items-center mb-5 pb-3">
            <div class="col-lg-6">
                <h3 style="color: hsl(140, 82%, 37%); font-weight: 700;">Climate Resilience</h3>
                <p style="line-height: 1.8; color: #555;">
                    ADS-Nyanza recognizes the worsening food insecurity further compounded by climate change and therefore supports climate smart initiatives by vulnerable groups and smallholders in improving food security and incomes from agriculture sustainably.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Strengthen technical capacities</strong> – Enhancing agriculture and nutrition connectedness (Agriculture-Nutrition Nexus) and income generation through surplus production amongst target communities.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Value Chains Development</strong> – Support produce value chains mapping and development, produce value addition and enhancing collective market access for better incomes.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Eco-friendly Agricultural production</strong> – Supports food production systems that are sustainable, with improved access to water and sanitation, and enhanced watershed management.
                </p>
            </div>
            <div class="col-lg-6">
                <img src="img/wedo3.jpg" class="img-fluid rounded shadow" alt="Climate Resilience" style="width: 100%; height: 350px; object-fit: cover;" onerror="this.src='https://placehold.co/600x350/f0f0f0/999?text=Climate+Program'">
            </div>
        </div>
        ...
        <div class="row g-5 align-items-center mb-5 pb-3 flex-lg-row-reverse">
            <div class="col-lg-6">
                <h3 style="color: hsl(140, 82%, 37%); font-weight: 700;">Women Empowerment & Justice</h3>
                <p style="line-height: 1.8; color: #555;">
                    ADS-Nyanza supports development and opening up of economic opportunities for vulnerable communities by facilitating building of strong entrepreneurial network of groups in communities.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Financial Inclusivity</strong> – Saving with Education concept (SwE) – Capacity building of community own resource persons and communities to form, manage and mobilize savings and loaning through groups and individual goal driven for financial inclusivity and entrepreneurial initiatives.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Business development services</strong> – Better markets access, Value Chains Development of key enterprises, and Household Economic Strengthening.
                </p>
            </div>
            <div class="col-lg-6">
                <img src="img/wedo1.jpg" class="img-fluid rounded shadow" alt="Women Empowerment" style="width: 100%; height: 350px; object-fit: cover;" onerror="this.src='https://placehold.co/600x350/f0f0f0/999?text=Women+Empowerment'">
            </div>
        </div>
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <h3 style="color: hsl(140, 82%, 37%); font-weight: 700;">Emergency Response</h3>
                <p style="line-height: 1.8; color: #555;">
                    ADS-Nyanza intervenes for basic human rights through promotive and preventive health for communities' wellbeing, working in partnership with Government departments and relevant stakeholders. Our focus is on the most vulnerable populations of the communities including women, youths and HIV-affected individuals.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Universal Health Coverage</strong> – Ensuring that women, youth, children and HIV-affected receive adequate and affordable health services by working closely with local health services providers and County departments.
                </p>
                <p style="line-height: 1.8; color: #555;">
                    <strong>Emergency Preparedness</strong> – Building community resilience to respond effectively to health emergencies, natural disasters, and other crises that affect vulnerable populations.
                </p>
            </div>
            <div class="col-lg-6">
                <img src="img/success02.jpg" class="img-fluid rounded shadow" alt="Emergency Response" style="width: 100%; height: 350px; object-fit: cover;" onerror="this.src='https://placehold.co/600x350/f0f0f0/999?text=Emergency+Response'">
            </div>
        </div>
...
<!-- Thematic Areas End -->
<!-- Our Coverage Start -->
<section class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
    <div class="container py-5">
        ...
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">Areas We Serve</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
            <p class="text-muted mx-auto" style="max-width: 700px; font-size: 1rem;">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="coverage-card">
                    <h4>Early Childhood Development (ECD)</h4>
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Kisumu, Homabay, Siaya, Nyamira, Vihiga</span>
                    </div>
                    <p>Nurturing holistic growth and early learning for children aged 0-3 years.</p>
                    <a href="ecd" class="coverage-link">Learn More →</a>
                </div>
            </div>

            <!-- 2. Strengthening Early Childhood Development - SECD -->
            <div class="col-md-6 col-lg-4">
                <div class="coverage-card">
                    <h4>Strengthening Early Childhood Development (SECD)</h4>
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Homabay, Nyamira, Vihiga</span>
                    </div>
                    <p>Strengthening early childhood development and community resilience.</p>
                    <a href="secd" class="coverage-link">Learn More →</a>
                </div>
            </div>

            <!-- 3. Integrated Climate Resilience Project -->
            <div class="col-md-6 col-lg-4">
                <div class="coverage-card">
                    <h4>Integrated Climate Resilience Project</h4>
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Homabay, Kisumu, Migori, Nyamira, Siaya</span>
                    </div>
                    <p>Strengthening adaptation, food security, and sustainable agricultural systems.</p>
                    <a href="icrp" class="coverage-link">Learn More →</a>
                </div>
            </div>

            <!-- 4. People's Empowerment for Sustainability -->
            <div class="col-md-6 col-lg-4">
                <div class="coverage-card">
                    <h4>People's Empowerment for Sustainability</h4>
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Kisumu, Siaya</span>
                    </div>
                    <p>Empowering communities through sustainable livelihoods and local governance.</p>
                    <a href="pesp" class="coverage-link">Learn More →</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="coverage-card">
                    ...
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Homabay County</span>
                    </div>
                    <p>Supporting HIV prevention and treatment efforts for vulnerable populations.</p>
                    <a href="Global_Fund" class="coverage-link">Learn More →</a>
                </div>
            </div>

            <!-- 6. Kaleidoscope Project -->
            <div class="col-md-6 col-lg-4">
                <div class="coverage-card">
                    <h4>Kaleidoscope Project</h4>
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Samburu, West Pokot </span>
                    </div>
                    <p>Inclusive development and empowerment of marginalized communities.</p>
                    <a href="kaliedoscope" class="coverage-link">Learn More →</a>
                </div>
            </div>

            <!-- 7. West Kenya Peace Initiative - Centered -->
            <div class="col-md-6 col-lg-4 offset-lg-2">
                <div class="coverage-card">
                    <h4>West Kenya Peace Initiative</h4>
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Kisumu, Siaya</span>
                    </div>
                    <p>Promoting peaceful coexistence, intercommunity dialogue, and conflict resolution.</p>
                    <a href="wkpi" class="coverage-link">Learn More →</a>
                </div>
            </div>

            <!-- 8. Emergency Response - Centered -->
            <div class="col-md-6 col-lg-4">
                <div class="coverage-card">
                    <h4>Emergency Response</h4>
                    <div class="counties">
                        <i class="bi bi-geo-alt-fill"></i>
                        <span>Kisumu, Siaya, Homabay, Migori, Nyamira, Vihiga</span>
                    </div>
                    <p>Enhancing community resilience and rapid humanitarian response.</p>
                    <a href="emergency" class="coverage-link">Learn More →</a>
                </div>
            </div>
...
<!-- ====== BOT and BOD SECTION START ====== -->
<!-- ===== BOARD OF TRUSTEES SECTION ===== -->
<section class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="background: linear-gradient(135deg, #f8fafc 0%, #ffffff 100%);">
    <div class="container py-5">
        ...
        <div class="text-center mb-5 mx-auto" style="max-width: 700px;">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">ADS–Nyanza Board of Trustees</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
            <p class="text-muted" style="font-size: 1rem; font-style: italic; max-width: 600px; margin: 0 auto;">Guardians of our mission and vision</p>
        </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="trustee-card">
                    <div class="trustee-image">
                        <img src="/updated/img/t2.jpg" alt="Rt. Rev'd Prof. David Hellington Kodia" onerror="this.src='https://placehold.co/300x300/2e7d32/white?text=Trustee'">
                    </div>
                    <div class="trustee-info">
                        <h5 class="trustee-name">The Rt. Rev'd Prof. David Hellington Kodia</h5>
                        <p class="trustee-title">Member, Board of Trustees</p>
                        <a href="/updated/The%20Board/BOT_The%20Rt.%20Rev%E2%80%99d%20Prof.%20David%20Hellington%20Kodia" class="trustee-btn">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="trustee-card">
                    <div class="trustee-image">
                        <img src="/updated/img/t3.jpg" alt="Rt. Rev'd Charles Ochieng Ong'injo" onerror="this.src='https://placehold.co/300x300/2e7d32/white?text=Trustee'">
                    </div>
                    <div class="trustee-info">
                        <h5 class="trustee-name">The Rt. Rev'd Charles Ochieng Ong'injo</h5>
                        <p class="trustee-title">Member, Board of Trustees</p>
                        <a href="/updated/The%20Board/BOT_The%20Rt.%20Revd%20Charles%20Ochieng%20Onginjo" class="trustee-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="trustee-card">
                    <div class="trustee-image">
                        <img src="/updated/img/t4.JPG" alt="Rt. Rev'd CS John Mark Haung' Godia" onerror="this.src='https://placehold.co/300x300/2e7d32/white?text=Trustee'">
                    </div>
                    <div class="trustee-info">
                        <h5 class="trustee-name">The Rt. Rev'd CS John Mark Haung' Godia</h5>
                        <p class="trustee-title">Member, Board of Trustees</p>
                        <a href="#" class="trustee-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="trustee-card">
                    <div class="trustee-image">
                        <img src="/updated/img/t5.jpg" alt="Rt. Rev'd Dr. Simon Edward Onyango" onerror="this.src='https://placehold.co/300x300/2e7d32/white?text=Trustee'">
                    </div>
                    <div class="trustee-info">
                        <h5 class="trustee-name">The Rt. Rev'd Dr. Simon Edward Onyango</h5>
                        <p class="trustee-title">Member, Board of Trustees</p>
                        <a href="#" class="trustee-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="trustee-card">
                    <div class="trustee-image">
                        <img src="/updated/img/t6.jpg" alt="Rt. Rev'd John Orina Omangi" onerror="this.src='https://placehold.co/300x300/2e7d32/white?text=Trustee'">
                    </div>
                    <div class="trustee-info">
                        <h5 class="trustee-name">The Rt. Rev'd John Orina Omangi</h5>
                        <p class="trustee-title">Member, Board of Trustees</p>
                        <a href="#" class="trustee-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="trustee-card">
                    <div class="trustee-image">
                        <img src="/updated/img/enos.jpg" alt="Rt. Rev'd CPA. Benard Enos Otieno Owuor" onerror="this.src='https://placehold.co/300x300/2e7d32/white?text=Trustee'">
                    </div>
                    <div class="trustee-info">
                        <h5 class="trustee-name">The Rt. Rev'd CPA. Benard Enos Otieno Owuor</h5>
                        <p class="trustee-title">Member, Board of Trustees</p>
                        <a href="/updated/The%20Board/BOT_The%20Rt.%20Revd%20CPA%20Benard%20Enos%20Otieno%20Owuor" class="trustee-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
...
<section class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="background: linear-gradient(135deg, #f8fafc 0%, #ffffff 100%);">
    <div class="container py-5">
        ...
        <div class="text-center mb-5 mx-auto" style="max-width: 700px;">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">ADS–Nyanza Board of Directors</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
            <p class="text-muted" style="font-size: 1rem; font-style: italic;">Strategic leaders driving our impact</p>
        </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b1.jpg" alt="Rt. Rev'd Charles Ochieng Ong'injo" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">The Rt. Rev'd Charles Ochieng Ong'injo</h5>
                        <p class="director-title">Board Chairman</p>
                        <a href="/updated/The%20Board/BOD_The%20Rt.%20Revd%20Charles%20Ochieng%20Onginjo" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/t6.jpg" alt="Rt. Rev'd John Orina Omangi" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">The Rt. Rev'd John Orina Omangi</h5>
                        <p class="director-title">Board Member</p>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/enos.jpg" alt="Rt. Rev'd CPA Benard Enos Otieno Owuor" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">The Rt. Rev'd CPA. Benard Enos Otieno Owuor</h5>
                        <p class="director-title">Honorary Treasurer, Finance & Admin</p>
                        <a href="/updated/The%20Board/BOD_The%20Rt.%20Rev%27d%20CPA.%20Benard%20Enos%20Otieno%20Owuor" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b5.jpg" alt="Rt. Rev'd Dr. Emily Awino Onyango" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">The Rt. Rev'd Dr. Emily Awino Onyango</h5>
                        <p class="director-title">Board Member</p>
                        <a href="/updated/The%20Board/BOD_The%20Rt.%20Rev%27d%20Dr.%20Emily%20Awino%20Onyango" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b3.jpg" alt="Mrs Nelly Atieno Otieno" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">Mrs Nelly Atieno Otieno</h5>
                        <p class="director-title">Programs Chairlady</p>
                        <a href="/updated/The%20Board/BOD_Mrs%20Nelly%20Atieno%20Otieno" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b6.jpg" alt="Dr Angeline Ochung Orwa" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">Dr Angeline Ochung Orwa</h5>
                        <p class="director-title">Board Member</p>
                        <a href="/updated/The%20Board/BOD_Dr%20Angeline%20Ochung%20Orwa" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b7.jpg" alt="Mr Fredrick Mito Nyunja" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">Mr Fredrick Mito Nyunja</h5>
                        <p class="director-title">Board Member</p>
                        <a href="/updated/The%20Board/BOD_Mr%20Fredrick%20Mito%20Nyunja" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b8.jpg" alt="Ms Jacqueline Alwala" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">Ms Jacqueline Alwala</h5>
                        <p class="director-title">Board Member</p>
                        <a href="/updated/The%20Board/BOD_Ms%20Jacqueline%20Alwala" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b9.jpg" alt="Mr Samwel Omondi Ochieng" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">Mr. Samwel Omondi Ochieng</h5>
                        <p class="director-title">Executive Director</p>
                        <a href="/updated/The%20Board/BOD_Mr.%20Samwel%20Omondi%20Ochieng" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 text-center">
                <div class="director-card">
                    <div class="director-image">
                        <img src="/updated/img/b10.jpg" alt="FCS Jophece Yogo" onerror="this.src='https://placehold.co/300x300/f0f0f0/999?text=Trustee'">
                    </div>
                    <div class="director-info">
                        <h5 class="director-name">FCS Jophece Yogo</h5>
                        <p class="director-title">Company Secretary</p>
                        <a href="#" class="director-btn">
                            <i class="bi bi-person-badge me-2"></i>View Profile
                            <i class="bi bi-arrow-right ms-1"></i>
                        </a>
...
<style>
/* Director Card - No Green Borders */
.director-card {
    background: white;
    border-radius: 20px;
    padding: 1.5rem 1rem;
...
/* Director Image - No Green Border */
.director-image {
    width: 140px;
    height: 140px;
    margin: 0 auto 1rem auto;

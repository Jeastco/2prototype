...
<section class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
    <div class="container py-5">
        ...
        <div class="text-center mb-5 mx-auto" style="max-width: 700px;">
            ...
            <h2 class="fw-bold mb-3" style="color: #1a2a3a;">We're Here to Help — Get in Touch</h2>
            <div class="mx-auto rounded-pill mb-3" style="width: 60px; height: 3px; background: hsl(140, 82%, 37%);"></div>
            <p class="text-muted">Have questions, feedback, or partnership ideas? Reach out to ADS–Nyanza today.</p>
        </div>
        ...
        <div class="row g-4 mb-5 text-center">
            <div class="col-lg-4 col-md-6">
                <div class="contact-card">
                    ...
                    <p class="contact-card-text">For any inquiries</p>
                    <h5 class="contact-number">+254 726 947044</h5>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="contact-card">
                    ...
                    <p class="contact-card-text">We'll get back to you soon</p>
                    <a href="mailto:ads@ads-nyanza.org" class="contact-email">ads@ads-nyanza.org</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="contact-card">
                    ...
                    <h5 class="contact-card-title">Visit Our Office</h5>
                    <p class="contact-card-text">Omolo Agar Rd, Next to Victoria Park,<br> ACK St. Peter's Church Compound, Kisumu</p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5 align-items-stretch">
            ...
            <div class="col-lg-6">
                <div class="form-container">
                    ...
                    <form action="mailto:ads@ads-nyanza.org" method="post" enctype="text/plain">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-icon"><i class="bi bi-person"></i></span>
                                    <input type="text" name="Name" class="form-control form-input" placeholder="Your Full Name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-icon"><i class="bi bi-envelope"></i></span>
                                    <input type="email" name="Email" class="form-control form-input" placeholder="Your Email Address" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group">
                                    <span class="input-group-icon"><i class="bi bi-tag"></i></span>
                                    <input type="text" name="Subject" class="form-control form-input" placeholder="Subject" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group">
                                    <span class="input-group-icon"><i class="bi bi-chat-dots"></i></span>
                                    <textarea name="Message" class="form-control form-input" rows="5" placeholder="Write your message here..." required></textarea>
                                </div>
                            </div>
                            <div class="col-12">
            ...
            <div class="col-lg-6">
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.810969707423!2d34.75183!3d-0.1099825!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182aa551217d5ce7%3A0xd032c97001431287!2sAck%20development%20services%20-%20nyanza%20region%20ltd%20(ads%20-%20nyanza)!5e0!3m2!1sen!2ske!4v1761554074604!5m2!1sen!2ske"
                        width="100%"
                        height="100%"
                        style="border:0;"
                        allowfullscreen=""
